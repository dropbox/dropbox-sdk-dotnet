...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Team merge request acceptance details</para>
    /// </summary>
    public class TeamMergeRequestAcceptedExtraDetails
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<TeamMergeRequestAcceptedExtraDetails> Encoder = new TeamMergeRequestAcceptedExtraDetailsEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<TeamMergeRequestAcceptedExtraDetails> Decoder = new TeamMergeRequestAcceptedExtraDetailsDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see
        /// cref="TeamMergeRequestAcceptedExtraDetails" /> class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="TeamMergeRequestAcceptedExtraDetails" />.</para>
        /// </summary>
        private class TeamMergeRequestAcceptedExtraDetailsEncoder : enc.StructEncoder<TeamMergeRequestAcceptedExtraDetails>
        {
            /// <summary>
            ...
            public override void EncodeFields(TeamMergeRequestAcceptedExtraDetails value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="TeamMergeRequestAcceptedExtraDetails" />.</para>
        /// </summary>
        private class TeamMergeRequestAcceptedExtraDetailsDecoder : enc.UnionDecoder<TeamMergeRequestAcceptedExtraDetails>
        {
            /// <summary>
            /// <para>Create a new instance of type <see
            /// cref="TeamMergeRequestAcceptedExtraDetails" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override TeamMergeRequestAcceptedExtraDetails Create()
            {
                return new TeamMergeRequestAcceptedExtraDetails();
            }
            ...
            protected override TeamMergeRequestAcceptedExtraDetails Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "primary_team":
        ...
        /// <summary>
        /// <para>Team merge request accepted details shown to the primary team.</para>
        /// </summary>
        public sealed class PrimaryTeam : TeamMergeRequestAcceptedExtraDetails
        {
            #pragma warning disable 108
            ...
            /// </summary>
            /// <param name="value">The value</param>
            public PrimaryTeam(PrimaryTeamRequestAcceptedDetails value)
            {
                this.Value = value;
            }
            /// <summary>
            ...
            /// </summary>
            public PrimaryTeamRequestAcceptedDetails Value { get; private set; }
            ...
            private class PrimaryTeamEncoder : enc.StructEncoder<PrimaryTeam>
            {
                ...
                {
                    WriteProperty("primary_team", value.Value, writer, global::Dropbox.Api.TeamLog.PrimaryTeamRequestAcceptedDetails.Encoder);
                }
            }
            ...
            private class PrimaryTeamDecoder : enc.StructDecoder<PrimaryTeam>
            {
                ...
                {
                    return new PrimaryTeam(global::Dropbox.Api.TeamLog.PrimaryTeamRequestAcceptedDetails.Decoder.DecodeFields(reader));
                }
            }
        ...
        /// <summary>
        /// <para>Team merge request accepted details shown to the secondary team.</para>
        /// </summary>
        public sealed class SecondaryTeam : TeamMergeRequestAcceptedExtraDetails
        {
            #pragma warning disable 108
            ...
            /// </summary>
            /// <param name="value">The value</param>
            public SecondaryTeam(SecondaryTeamRequestAcceptedDetails value)
            {
                this.Value = value;
            }
            /// <summary>
            ...
            /// <para>Gets the value of this instance.</para>
            /// </summary>
            public SecondaryTeamRequestAcceptedDetails Value { get; private set; }
            ...
            private class SecondaryTeamEncoder : enc.StructEncoder<SecondaryTeam>
            {
                ...
                {
                    WriteProperty("secondary_team", value.Value, writer, global::Dropbox.Api.TeamLog.SecondaryTeamRequestAcceptedDetails.Encoder);
                }
            }
            ...
            private class SecondaryTeamDecoder : enc.StructDecoder<SecondaryTeam>
            {
                ...
                {
                    return new SecondaryTeam(global::Dropbox.Api.TeamLog.SecondaryTeamRequestAcceptedDetails.Decoder.DecodeFields(reader));
                }
            }
        ...
        /// </summary>
        public sealed class Other : TeamMergeRequestAcceptedExtraDetails
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.FileProperties
{
    ...
    /// <summary>
    /// <para>A subset of the property fields described by the corresponding <see
    /// cref="PropertyGroupTemplate" />. Properties are always added to a Dropbox file as a
    /// <see cref="PropertyGroup" />. The possible key names and value types in this group are
    /// defined by the corresponding <see cref="PropertyGroupTemplate" />.</para>
    /// </summary>
    public class PropertyGroup
    {
        ...
        /// </summary>
        /// <param name="templateId">A unique identifier for the associated template.</param>
        /// <param name="fields">The actual properties associated with the template. There can
        /// be up to 32 property types per template.</param>
        ...
        /// <summary>
        /// <para>A unique identifier for the associated template.</para>
        /// </summary>
        public string TemplateId { get; protected set; }

        /// <summary>
        /// <para>The actual properties associated with the template. There can be up to 32
        /// property types per template.</para>
        /// </summary>
        ...
        private class PropertyGroupEncoder : enc.StructEncoder<PropertyGroup>
        {
            ...
            public override void EncodeFields(PropertyGroup value, enc.IJsonWriter writer)
            {
                ...
                WriteListProperty("fields", value.Fields, writer, global::Dropbox.Api.FileProperties.PropertyField.Encoder);
            }
        }
            ...
            protected override void SetField(PropertyGroup value, string fieldName, enc.IJsonReader reader)
            {
                switch (fieldName)
                {
                    case "template_id":
                        ...
                        break;
                    case "fields":
                        value.Fields = ReadList<PropertyField>(reader, global::Dropbox.Api.FileProperties.PropertyField.Decoder);
                        break;
                    default:
                        reader.Skip();
                        break;

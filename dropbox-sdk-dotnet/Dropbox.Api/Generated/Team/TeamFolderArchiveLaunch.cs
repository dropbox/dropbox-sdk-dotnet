...
namespace Dropbox.Api.Team
{
    ...
    /// <summary>
    /// <para>The team folder archive launch object</para>
    /// </summary>
    public class TeamFolderArchiveLaunch
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<TeamFolderArchiveLaunch> Encoder = new TeamFolderArchiveLaunchEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<TeamFolderArchiveLaunch> Decoder = new TeamFolderArchiveLaunchDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="TeamFolderArchiveLaunch" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="TeamFolderArchiveLaunch" />.</para>
        /// </summary>
        private class TeamFolderArchiveLaunchEncoder : enc.StructEncoder<TeamFolderArchiveLaunch>
        {
            /// <summary>
            ...
            public override void EncodeFields(TeamFolderArchiveLaunch value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="TeamFolderArchiveLaunch" />.</para>
        /// </summary>
        private class TeamFolderArchiveLaunchDecoder : enc.UnionDecoder<TeamFolderArchiveLaunch>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="TeamFolderArchiveLaunch"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override TeamFolderArchiveLaunch Create()
            {
                return new TeamFolderArchiveLaunch();
            }
            ...
            protected override TeamFolderArchiveLaunch Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "complete":
        ...
        /// </summary>
        public sealed class Complete : TeamFolderArchiveLaunch
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class AsyncJobId : TeamFolderArchiveLaunch
        {
            #pragma warning disable 108

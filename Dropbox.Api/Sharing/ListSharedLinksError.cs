...
namespace Dropbox.Api.Sharing
{
    ...
    /// </summary>
    public class ListSharedLinksError
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<ListSharedLinksError> Encoder = new ListSharedLinksErrorEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<ListSharedLinksError> Decoder = new ListSharedLinksErrorDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="ListSharedLinksError" />
        /// class.</para>
        /// </summary>
        public ListSharedLinksError()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="ListSharedLinksError" />.</para>
        /// </summary>
        private class ListSharedLinksErrorEncoder : enc.StructEncoder<ListSharedLinksError>
        {
            /// <summary>
            ...
            public override void EncodeFields(ListSharedLinksError value, enc.IJsonWriter writer)
            {
                if (value is Path)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="ListSharedLinksError" />.</para>
        /// </summary>
        private class ListSharedLinksErrorDecoder : enc.UnionDecoder<ListSharedLinksError>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="ListSharedLinksError" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override ListSharedLinksError Create()
            {
                return new ListSharedLinksError();
            }
            ...
            protected override ListSharedLinksError Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "path":
        ...
        /// </summary>
        public sealed class Path : ListSharedLinksError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : ListSharedLinksError
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.TeamLog
{
    ...
    public class ObjectLabelAddedDetails
    {
        ...
        public ObjectLabelAddedDetails()
        {
        }
        ...
        private class ObjectLabelAddedDetailsDecoder : enc.StructDecoder<ObjectLabelAddedDetails>
        {
            ...
            protected override void SetField(ObjectLabelAddedDetails value, string fieldName, enc.IJsonReader reader)
            {
                switch (fieldName)
                {
                    case "label_type":

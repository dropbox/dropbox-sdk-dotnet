...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for deciding whether applying link restrictions on all team owned
    /// folders</para>
    /// </summary>
    public class FolderLinkRestrictionPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<FolderLinkRestrictionPolicy> Encoder = new FolderLinkRestrictionPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<FolderLinkRestrictionPolicy> Decoder = new FolderLinkRestrictionPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="FolderLinkRestrictionPolicy" />
        /// class.</para>
        /// </summary>
        public FolderLinkRestrictionPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="FolderLinkRestrictionPolicy" />.</para>
        /// </summary>
        private class FolderLinkRestrictionPolicyEncoder : enc.StructEncoder<FolderLinkRestrictionPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(FolderLinkRestrictionPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="FolderLinkRestrictionPolicy" />.</para>
        /// </summary>
        private class FolderLinkRestrictionPolicyDecoder : enc.UnionDecoder<FolderLinkRestrictionPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="FolderLinkRestrictionPolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override FolderLinkRestrictionPolicy Create()
            {
                return new FolderLinkRestrictionPolicy();
            }
            ...
            protected override FolderLinkRestrictionPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : FolderLinkRestrictionPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : FolderLinkRestrictionPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : FolderLinkRestrictionPolicy
        {
            #pragma warning disable 108

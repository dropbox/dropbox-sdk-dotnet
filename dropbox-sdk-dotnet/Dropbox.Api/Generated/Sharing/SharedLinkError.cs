...
namespace Dropbox.Api.Sharing
{
    ...
    public class SharedLinkError
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<SharedLinkError> Encoder = new SharedLinkErrorEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<SharedLinkError> Decoder = new SharedLinkErrorDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="SharedLinkError" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="SharedLinkError" />.</para>
        /// </summary>
        private class SharedLinkErrorEncoder : enc.StructEncoder<SharedLinkError>
        {
            /// <summary>
            ...
            public override void EncodeFields(SharedLinkError value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="SharedLinkError" />.</para>
        /// </summary>
        private class SharedLinkErrorDecoder : enc.UnionDecoder<SharedLinkError>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="SharedLinkError" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override SharedLinkError Create()
            {
                return new SharedLinkError();
            }
            ...
            protected override SharedLinkError Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
        ...
        /// </summary>
        public sealed class SharedLinkNotFound : SharedLinkError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class SharedLinkAccessDenied : SharedLinkError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class UnsupportedLinkType : SharedLinkError
        {
            #pragma warning disable 108
        ...
        /// fields.</para>
        /// </summary>
        public sealed class UnsupportedParameterField : SharedLinkError
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Web sessions fixed length policy.</para>
    /// </summary>
    public class WebSessionsFixedLengthPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<WebSessionsFixedLengthPolicy> Encoder = new WebSessionsFixedLengthPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<WebSessionsFixedLengthPolicy> Decoder = new WebSessionsFixedLengthPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="WebSessionsFixedLengthPolicy" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="WebSessionsFixedLengthPolicy" />.</para>
        /// </summary>
        private class WebSessionsFixedLengthPolicyEncoder : enc.StructEncoder<WebSessionsFixedLengthPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(WebSessionsFixedLengthPolicy value, enc.IJsonWriter writer)
            {
                if (value is Defined)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="WebSessionsFixedLengthPolicy" />.</para>
        /// </summary>
        private class WebSessionsFixedLengthPolicyDecoder : enc.UnionDecoder<WebSessionsFixedLengthPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="WebSessionsFixedLengthPolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override WebSessionsFixedLengthPolicy Create()
            {
                return new WebSessionsFixedLengthPolicy();
            }
            ...
            protected override WebSessionsFixedLengthPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "defined":
        ...
        /// <summary>
        /// <para>Defined fixed session length.</para>
        /// </summary>
        public sealed class Defined : WebSessionsFixedLengthPolicy
        {
            ...
            private class DefinedEncoder : enc.StructEncoder<Defined>
            {
                ...
                {
                    WriteProperty("defined", value.Value, writer, global::Dropbox.Api.TeamLog.DurationLogInfo.Encoder);
                }
            }
        ...
        /// <summary>
        /// <para>Undefined fixed session length.</para>
        /// </summary>
        public sealed class Undefined : WebSessionsFixedLengthPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : WebSessionsFixedLengthPolicy
        {
            #pragma warning disable 108

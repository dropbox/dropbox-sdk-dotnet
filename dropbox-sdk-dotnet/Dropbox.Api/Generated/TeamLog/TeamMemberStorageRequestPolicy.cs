...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for deciding whether team members can request increased storage limits
    /// from admins</para>
    /// </summary>
    public class TeamMemberStorageRequestPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<TeamMemberStorageRequestPolicy> Encoder = new TeamMemberStorageRequestPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<TeamMemberStorageRequestPolicy> Decoder = new TeamMemberStorageRequestPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="TeamMemberStorageRequestPolicy"
        /// /> class.</para>
        /// </summary>
        public TeamMemberStorageRequestPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="TeamMemberStorageRequestPolicy" />.</para>
        /// </summary>
        private class TeamMemberStorageRequestPolicyEncoder : enc.StructEncoder<TeamMemberStorageRequestPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(TeamMemberStorageRequestPolicy value, enc.IJsonWriter writer)
            {
                if (value is Default)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="TeamMemberStorageRequestPolicy" />.</para>
        /// </summary>
        private class TeamMemberStorageRequestPolicyDecoder : enc.UnionDecoder<TeamMemberStorageRequestPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="TeamMemberStorageRequestPolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override TeamMemberStorageRequestPolicy Create()
            {
                return new TeamMemberStorageRequestPolicy();
            }
            ...
            protected override TeamMemberStorageRequestPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "default":
        ...
        /// </summary>
        public sealed class Default : TeamMemberStorageRequestPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Disabled : TeamMemberStorageRequestPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : TeamMemberStorageRequestPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : TeamMemberStorageRequestPolicy
        {
            #pragma warning disable 108

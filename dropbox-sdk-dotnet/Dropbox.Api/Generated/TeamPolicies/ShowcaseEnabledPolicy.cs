...
namespace Dropbox.Api.TeamPolicies
{
    ...
    /// <summary>
    /// <para>The showcase enabled policy object</para>
    /// </summary>
    public class ShowcaseEnabledPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<ShowcaseEnabledPolicy> Encoder = new ShowcaseEnabledPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<ShowcaseEnabledPolicy> Decoder = new ShowcaseEnabledPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="ShowcaseEnabledPolicy" />
        /// class.</para>
        /// </summary>
        public ShowcaseEnabledPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="ShowcaseEnabledPolicy" />.</para>
        /// </summary>
        private class ShowcaseEnabledPolicyEncoder : enc.StructEncoder<ShowcaseEnabledPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(ShowcaseEnabledPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="ShowcaseEnabledPolicy" />.</para>
        /// </summary>
        private class ShowcaseEnabledPolicyDecoder : enc.UnionDecoder<ShowcaseEnabledPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="ShowcaseEnabledPolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override ShowcaseEnabledPolicy Create()
            {
                return new ShowcaseEnabledPolicy();
            }
            ...
            protected override ShowcaseEnabledPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// <summary>
        /// <para>Showcase is disabled.</para>
        /// </summary>
        public sealed class Disabled : ShowcaseEnabledPolicy
        {
            #pragma warning disable 108
        ...
        /// <summary>
        /// <para>Showcase is enabled.</para>
        /// </summary>
        public sealed class Enabled : ShowcaseEnabledPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : ShowcaseEnabledPolicy
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.TeamLog
{
    ...
    public class PaperChangePolicyDetails
    {
        ...
        public PaperChangePolicyDetails(global::Dropbox.Api.TeamPolicies.PaperEnabledPolicy newValue,
                                        global::Dropbox.Api.TeamPolicies.PaperEnabledPolicy previousValue = null)
        {
            if (newValue == null)
            {
        ...
        /// </summary>
        public global::Dropbox.Api.TeamPolicies.PaperEnabledPolicy NewValue { get; protected set; }

        /// <summary>
        /// <para>Previous Dropbox Paper policy. Might be missing due to historical data
        /// gap.</para>
        /// </summary>
        public global::Dropbox.Api.TeamPolicies.PaperEnabledPolicy PreviousValue { get; protected set; }
        ...
        private class PaperChangePolicyDetailsEncoder : enc.StructEncoder<PaperChangePolicyDetails>
        {
            ...
            {
                WriteProperty("new_value", value.NewValue, writer, global::Dropbox.Api.TeamPolicies.PaperEnabledPolicy.Encoder);
                if (value.PreviousValue != null)
                {
                    WriteProperty("previous_value", value.PreviousValue, writer, global::Dropbox.Api.TeamPolicies.PaperEnabledPolicy.Encoder);
                }
            }
        }
        ...
        private class PaperChangePolicyDetailsDecoder : enc.StructDecoder<PaperChangePolicyDetails>
        {
            ...
            protected override void SetField(PaperChangePolicyDetails value, string fieldName, enc.IJsonReader reader)
            {
                ...
                {
                    case "new_value":
                        value.NewValue = global::Dropbox.Api.TeamPolicies.PaperEnabledPolicy.Decoder.Decode(reader);
                        break;
                    case "previous_value":
                        value.PreviousValue = global::Dropbox.Api.TeamPolicies.PaperEnabledPolicy.Decoder.Decode(reader);
                        break;
                    default:
                        reader.Skip();
                        break;

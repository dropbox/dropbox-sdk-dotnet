...
namespace Dropbox.Api.Sharing
{
    ...
    /// <summary>
    /// <para>The viewer info policy object</para>
    /// </summary>
    public class ViewerInfoPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<ViewerInfoPolicy> Encoder = new ViewerInfoPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<ViewerInfoPolicy> Decoder = new ViewerInfoPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="ViewerInfoPolicy" />
        /// class.</para>
        /// </summary>
        public ViewerInfoPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="ViewerInfoPolicy" />.</para>
        /// </summary>
        private class ViewerInfoPolicyEncoder : enc.StructEncoder<ViewerInfoPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(ViewerInfoPolicy value, enc.IJsonWriter writer)
            {
                if (value is Enabled)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="ViewerInfoPolicy" />.</para>
        /// </summary>
        private class ViewerInfoPolicyDecoder : enc.UnionDecoder<ViewerInfoPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="ViewerInfoPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override ViewerInfoPolicy Create()
            {
                return new ViewerInfoPolicy();
            }
            ...
            protected override ViewerInfoPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "enabled":
        ...
        /// <summary>
        /// <para>Viewer information is available on this file.</para>
        /// </summary>
        public sealed class Enabled : ViewerInfoPolicy
        {
            #pragma warning disable 108
            ...
            private class EnabledDecoder : enc.StructDecoder<Enabled>
            {
                ...
                /// <param name="reader">The json reader.</param>
                /// <returns>The decoded object.</returns>
                public override Enabled DecodeFields(enc.IJsonReader reader)
                {
        ...
        /// <summary>
        /// <para>Viewer information is disabled on this file.</para>
        /// </summary>
        public sealed class Disabled : ViewerInfoPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : ViewerInfoPolicy
        {
            #pragma warning disable 108

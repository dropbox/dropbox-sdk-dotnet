...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for pairing personal account to work account</para>
    /// </summary>
    public class TwoAccountPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<TwoAccountPolicy> Encoder = new TwoAccountPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<TwoAccountPolicy> Decoder = new TwoAccountPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="TwoAccountPolicy" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="TwoAccountPolicy" />.</para>
        /// </summary>
        private class TwoAccountPolicyEncoder : enc.StructEncoder<TwoAccountPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(TwoAccountPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="TwoAccountPolicy" />.</para>
        /// </summary>
        private class TwoAccountPolicyDecoder : enc.UnionDecoder<TwoAccountPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="TwoAccountPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override TwoAccountPolicy Create()
            {
                return new TwoAccountPolicy();
            }
            ...
            protected override TwoAccountPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : TwoAccountPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : TwoAccountPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : TwoAccountPolicy
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.Team
{
    ...
    /// <summary>
    /// <para>The team folder list continue error object</para>
    /// </summary>
    public class TeamFolderListContinueError
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<TeamFolderListContinueError> Encoder = new TeamFolderListContinueErrorEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<TeamFolderListContinueError> Decoder = new TeamFolderListContinueErrorDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="TeamFolderListContinueError" />
        /// class.</para>
        /// </summary>
        public TeamFolderListContinueError()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="TeamFolderListContinueError" />.</para>
        /// </summary>
        private class TeamFolderListContinueErrorEncoder : enc.StructEncoder<TeamFolderListContinueError>
        {
            /// <summary>
            ...
            public override void EncodeFields(TeamFolderListContinueError value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="TeamFolderListContinueError" />.</para>
        /// </summary>
        private class TeamFolderListContinueErrorDecoder : enc.UnionDecoder<TeamFolderListContinueError>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="TeamFolderListContinueError"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override TeamFolderListContinueError Create()
            {
                return new TeamFolderListContinueError();
            }
            ...
            protected override TeamFolderListContinueError Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "invalid_cursor":
        ...
        /// </summary>
        public sealed class InvalidCursor : TeamFolderListContinueError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : TeamFolderListContinueError
        {
            #pragma warning disable 108

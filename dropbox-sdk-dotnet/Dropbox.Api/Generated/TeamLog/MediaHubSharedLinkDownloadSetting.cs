...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Media Hub shared link download setting</para>
    /// </summary>
    public class MediaHubSharedLinkDownloadSetting
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<MediaHubSharedLinkDownloadSetting> Encoder = new MediaHubSharedLinkDownloadSettingEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<MediaHubSharedLinkDownloadSetting> Decoder = new MediaHubSharedLinkDownloadSettingDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see
        /// cref="MediaHubSharedLinkDownloadSetting" /> class.</para>
        /// </summary>
        public MediaHubSharedLinkDownloadSetting()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="MediaHubSharedLinkDownloadSetting" />.</para>
        /// </summary>
        private class MediaHubSharedLinkDownloadSettingEncoder : enc.StructEncoder<MediaHubSharedLinkDownloadSetting>
        {
            /// <summary>
            ...
            public override void EncodeFields(MediaHubSharedLinkDownloadSetting value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="MediaHubSharedLinkDownloadSetting" />.</para>
        /// </summary>
        private class MediaHubSharedLinkDownloadSettingDecoder : enc.UnionDecoder<MediaHubSharedLinkDownloadSetting>
        {
            /// <summary>
            /// <para>Create a new instance of type <see
            /// cref="MediaHubSharedLinkDownloadSetting" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override MediaHubSharedLinkDownloadSetting Create()
            {
                return new MediaHubSharedLinkDownloadSetting();
            }
            ...
            protected override MediaHubSharedLinkDownloadSetting Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : MediaHubSharedLinkDownloadSetting
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : MediaHubSharedLinkDownloadSetting
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : MediaHubSharedLinkDownloadSetting
        {
            #pragma warning disable 108

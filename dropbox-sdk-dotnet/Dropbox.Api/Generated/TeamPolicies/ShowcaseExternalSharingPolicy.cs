...
namespace Dropbox.Api.TeamPolicies
{
    ...
    /// <summary>
    /// <para>The showcase external sharing policy object</para>
    /// </summary>
    public class ShowcaseExternalSharingPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<ShowcaseExternalSharingPolicy> Encoder = new ShowcaseExternalSharingPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<ShowcaseExternalSharingPolicy> Decoder = new ShowcaseExternalSharingPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="ShowcaseExternalSharingPolicy"
        /// /> class.</para>
        /// </summary>
        public ShowcaseExternalSharingPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="ShowcaseExternalSharingPolicy" />.</para>
        /// </summary>
        private class ShowcaseExternalSharingPolicyEncoder : enc.StructEncoder<ShowcaseExternalSharingPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(ShowcaseExternalSharingPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="ShowcaseExternalSharingPolicy" />.</para>
        /// </summary>
        private class ShowcaseExternalSharingPolicyDecoder : enc.UnionDecoder<ShowcaseExternalSharingPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="ShowcaseExternalSharingPolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override ShowcaseExternalSharingPolicy Create()
            {
                return new ShowcaseExternalSharingPolicy();
            }
            ...
            protected override ShowcaseExternalSharingPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// <summary>
        /// <para>Do not allow showcases to be shared with people not on the team.</para>
        /// </summary>
        public sealed class Disabled : ShowcaseExternalSharingPolicy
        {
            #pragma warning disable 108
        ...
        /// <summary>
        /// <para>Allow showcases to be shared with people not on the team.</para>
        /// </summary>
        public sealed class Enabled : ShowcaseExternalSharingPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : ShowcaseExternalSharingPolicy
        {
            #pragma warning disable 108

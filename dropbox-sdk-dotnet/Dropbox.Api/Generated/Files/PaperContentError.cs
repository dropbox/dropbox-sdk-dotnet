...
namespace Dropbox.Api.Files
{
    ...
    /// <summary>
    /// <para>The paper content error object</para>
    /// </summary>
    public class PaperContentError
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<PaperContentError> Encoder = new PaperContentErrorEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<PaperContentError> Decoder = new PaperContentErrorDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="PaperContentError" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="PaperContentError" />.</para>
        /// </summary>
        private class PaperContentErrorEncoder : enc.StructEncoder<PaperContentError>
        {
            /// <summary>
            ...
            public override void EncodeFields(PaperContentError value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="PaperContentError" />.</para>
        /// </summary>
        private class PaperContentErrorDecoder : enc.UnionDecoder<PaperContentError>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="PaperContentError" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override PaperContentError Create()
            {
                return new PaperContentError();
            }
            ...
            protected override PaperContentError Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
        ...
        /// </summary>
        public sealed class InsufficientPermissions : PaperContentError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class ContentMalformed : PaperContentError
        {
            #pragma warning disable 108
        ...
        /// docs.</para>
        /// </summary>
        public sealed class DocLengthExceeded : PaperContentError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class ImageSizeExceeded : PaperContentError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : PaperContentError
        {
            #pragma warning disable 108

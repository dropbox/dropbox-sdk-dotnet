...
namespace Dropbox.Api.Sharing
{
    ...
    /// </summary>
    public class UpdateFilePolicyError
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<UpdateFilePolicyError> Encoder = new UpdateFilePolicyErrorEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<UpdateFilePolicyError> Decoder = new UpdateFilePolicyErrorDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="UpdateFilePolicyError" />
        /// class.</para>
        /// </summary>
        public UpdateFilePolicyError()
        {
        }
        ...
        /// <summary>
        /// <para>Gets a value indicating whether this instance is InvalidFileSettings</para>
        /// </summary>
        public bool IsInvalidFileSettings
        {
            get
            {
                return this is InvalidFileSettings;
            }
        }

        /// <summary>
        /// <para>Gets this instance as a InvalidFileSettings, or <c>null</c>.</para>
        /// </summary>
        public InvalidFileSettings AsInvalidFileSettings
        {
            get
            {
                return this as InvalidFileSettings;
            }
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="UpdateFilePolicyError" />.</para>
        /// </summary>
        private class UpdateFilePolicyErrorEncoder : enc.StructEncoder<UpdateFilePolicyError>
        {
            /// <summary>
            ...
            public override void EncodeFields(UpdateFilePolicyError value, enc.IJsonWriter writer)
            {
                ...
                if (value is InvalidFileSettings)
                {
                    WriteProperty(".tag", "invalid_file_settings", writer, enc.StringEncoder.Instance);
                    InvalidFileSettings.Encoder.EncodeFields((InvalidFileSettings)value, writer);
                    return;
                }
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="UpdateFilePolicyError" />.</para>
        /// </summary>
        private class UpdateFilePolicyErrorDecoder : enc.UnionDecoder<UpdateFilePolicyError>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="UpdateFilePolicyError"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override UpdateFilePolicyError Create()
            {
                return new UpdateFilePolicyError();
            }
            ...
            protected override UpdateFilePolicyError Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "access_error":
                    ...
                    case "invalid_file_settings":
                        return InvalidFileSettings.Decoder.DecodeFields(reader);
                    case "no_permission":
        ...
        /// </summary>
        public sealed class AccessError : UpdateFilePolicyError
        {
            #pragma warning disable 108
        ...
        /// <summary>
        /// <para>The file settings are invalid.</para>
        /// </summary>
        public sealed class InvalidFileSettings : UpdateFilePolicyError
        {
            #pragma warning disable 108
            ...
            /// <para>The encoder instance.</para>
            /// </summary>
            internal static enc.StructEncoder<InvalidFileSettings> Encoder = new InvalidFileSettingsEncoder();

            /// <summary>
            /// <para>The decoder instance.</para>
            /// </summary>
            internal static enc.StructDecoder<InvalidFileSettings> Decoder = new InvalidFileSettingsDecoder();

            /// <summary>
            /// <para>Initializes a new instance of the <see cref="InvalidFileSettings" />
            /// class.</para>
            /// </summary>
            private InvalidFileSettings()
            {
            }

            /// <summary>
            /// <para>A singleton instance of InvalidFileSettings</para>
            /// </summary>
            public static readonly InvalidFileSettings Instance = new InvalidFileSettings();

            #region Encoder class

            /// <summary>
            /// <para>Encoder for  <see cref="InvalidFileSettings" />.</para>
            /// </summary>
            private class InvalidFileSettingsEncoder : enc.StructEncoder<InvalidFileSettings>
            {
                /// <summary>
                /// <para>Encode fields of given value.</para>
                /// </summary>
                /// <param name="value">The value.</param>
                /// <param name="writer">The writer.</param>
                public override void EncodeFields(InvalidFileSettings value, enc.IJsonWriter writer)
                {
                }
            }
            ...
            /// <summary>
            /// <para>Decoder for  <see cref="InvalidFileSettings" />.</para>
            /// </summary>
            private class InvalidFileSettingsDecoder : enc.StructDecoder<InvalidFileSettings>
            {
                /// <summary>
                /// <para>Create a new instance of type <see cref="InvalidFileSettings"
                /// />.</para>
                /// </summary>
                /// <returns>The struct instance.</returns>
                protected override InvalidFileSettings Create()
                {
                    return InvalidFileSettings.Instance;
                }
        ...
        /// </summary>
        public sealed class NoPermission : UpdateFilePolicyError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : UpdateFilePolicyError
        {
            #pragma warning disable 108

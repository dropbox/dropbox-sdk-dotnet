...
namespace Dropbox.Api.TeamPolicies
{
    ...
    /// <summary>
    /// <para>The file locking policy state object</para>
    /// </summary>
    public class FileLockingPolicyState
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<FileLockingPolicyState> Encoder = new FileLockingPolicyStateEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<FileLockingPolicyState> Decoder = new FileLockingPolicyStateDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="FileLockingPolicyState" />
        /// class.</para>
        /// </summary>
        public FileLockingPolicyState()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="FileLockingPolicyState" />.</para>
        /// </summary>
        private class FileLockingPolicyStateEncoder : enc.StructEncoder<FileLockingPolicyState>
        {
            /// <summary>
            ...
            public override void EncodeFields(FileLockingPolicyState value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="FileLockingPolicyState" />.</para>
        /// </summary>
        private class FileLockingPolicyStateDecoder : enc.UnionDecoder<FileLockingPolicyState>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="FileLockingPolicyState"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override FileLockingPolicyState Create()
            {
                return new FileLockingPolicyState();
            }
            ...
            protected override FileLockingPolicyState Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// <summary>
        /// <para>File locking feature is disabled.</para>
        /// </summary>
        public sealed class Disabled : FileLockingPolicyState
        {
            #pragma warning disable 108
        ...
        /// <summary>
        /// <para>File locking feature is allowed.</para>
        /// </summary>
        public sealed class Enabled : FileLockingPolicyState
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : FileLockingPolicyState
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.TeamPolicies
{
    ...
    /// <summary>
    /// <para>The sso policy object</para>
    /// </summary>
    public class SsoPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<SsoPolicy> Encoder = new SsoPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<SsoPolicy> Decoder = new SsoPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="SsoPolicy" /> class.</para>
        /// </summary>
        public SsoPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="SsoPolicy" />.</para>
        /// </summary>
        private class SsoPolicyEncoder : enc.StructEncoder<SsoPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(SsoPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="SsoPolicy" />.</para>
        /// </summary>
        private class SsoPolicyDecoder : enc.UnionDecoder<SsoPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="SsoPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override SsoPolicy Create()
            {
            ...
            protected override SsoPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// <summary>
        /// <para>Users will be able to sign in with their Dropbox credentials.</para>
        /// </summary>
        public sealed class Disabled : SsoPolicy
        {
            #pragma warning disable 108
        ...
        /// <summary>
        /// <para>Users will be able to sign in with either their Dropbox or single sign-on
        /// credentials.</para>
        /// </summary>
        public sealed class Optional : SsoPolicy
        {
            #pragma warning disable 108
        ...
        /// <summary>
        /// <para>Users will be required to sign in with their single sign-on
        /// credentials.</para>
        /// </summary>
        public sealed class Required : SsoPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : SsoPolicy
        {
            #pragma warning disable 108

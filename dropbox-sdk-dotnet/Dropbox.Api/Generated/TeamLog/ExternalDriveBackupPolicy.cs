...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for controlling team access to external drive backup feature</para>
    /// </summary>
    public class ExternalDriveBackupPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<ExternalDriveBackupPolicy> Encoder = new ExternalDriveBackupPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<ExternalDriveBackupPolicy> Decoder = new ExternalDriveBackupPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="ExternalDriveBackupPolicy" />
        /// class.</para>
        /// </summary>
        public ExternalDriveBackupPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="ExternalDriveBackupPolicy" />.</para>
        /// </summary>
        private class ExternalDriveBackupPolicyEncoder : enc.StructEncoder<ExternalDriveBackupPolicy>
        {
            /// <summary>
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="ExternalDriveBackupPolicy" />.</para>
        /// </summary>
        private class ExternalDriveBackupPolicyDecoder : enc.UnionDecoder<ExternalDriveBackupPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="ExternalDriveBackupPolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override ExternalDriveBackupPolicy Create()
            {
                return new ExternalDriveBackupPolicy();
            }
            ...
            protected override ExternalDriveBackupPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : ExternalDriveBackupPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : ExternalDriveBackupPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : ExternalDriveBackupPolicy
        {
            #pragma warning disable 108

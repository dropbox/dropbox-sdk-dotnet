...
namespace Dropbox.Api.TeamPolicies
{
    ...
    /// <summary>
    /// <para>Policy governing whether new links shared outside the team require
    /// passwords.</para>
    /// </summary>
    public class EnforceLinkPasswordPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<EnforceLinkPasswordPolicy> Encoder = new EnforceLinkPasswordPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<EnforceLinkPasswordPolicy> Decoder = new EnforceLinkPasswordPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="EnforceLinkPasswordPolicy" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="EnforceLinkPasswordPolicy" />.</para>
        /// </summary>
        private class EnforceLinkPasswordPolicyEncoder : enc.StructEncoder<EnforceLinkPasswordPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(EnforceLinkPasswordPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="EnforceLinkPasswordPolicy" />.</para>
        /// </summary>
        private class EnforceLinkPasswordPolicyDecoder : enc.UnionDecoder<EnforceLinkPasswordPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="EnforceLinkPasswordPolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override EnforceLinkPasswordPolicy Create()
            {
                return new EnforceLinkPasswordPolicy();
            }
            ...
            protected override EnforceLinkPasswordPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "optional":
        ...
        /// <summary>
        /// <para>New links shared outside the team do not require passwords.</para>
        /// </summary>
        public sealed class Optional : EnforceLinkPasswordPolicy
        {
            #pragma warning disable 108
        ...
        /// <summary>
        /// <para>New links shared outside the team require passwords.</para>
        /// </summary>
        public sealed class Required : EnforceLinkPasswordPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : EnforceLinkPasswordPolicy
        {
            #pragma warning disable 108

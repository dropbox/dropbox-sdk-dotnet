...
namespace Dropbox.Api.Files
{
    ...
    /// <summary>
    /// <para>The upload session append error object</para>
    /// </summary>
    public class UploadSessionAppendError
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<UploadSessionAppendError> Encoder = new UploadSessionAppendErrorEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<UploadSessionAppendError> Decoder = new UploadSessionAppendErrorDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="UploadSessionAppendError" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="UploadSessionAppendError" />.</para>
        /// </summary>
        private class UploadSessionAppendErrorEncoder : enc.StructEncoder<UploadSessionAppendError>
        {
            /// <summary>
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="UploadSessionAppendError" />.</para>
        /// </summary>
        private class UploadSessionAppendErrorDecoder : enc.UnionDecoder<UploadSessionAppendError>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="UploadSessionAppendError"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override UploadSessionAppendError Create()
            {
                return new UploadSessionAppendError();
            }
            ...
            protected override UploadSessionAppendError Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
        ...
        /// for 7 days.</para>
        /// </summary>
        public sealed class NotFound : UploadSessionAppendError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Closed : UploadSessionAppendError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : UploadSessionAppendError
        {
            #pragma warning disable 108

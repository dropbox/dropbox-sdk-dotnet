...
namespace Dropbox.Api.Files
{
    ...
    /// <summary>
    /// <para>The create folder batch job status object</para>
    /// </summary>
    public class CreateFolderBatchJobStatus
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<CreateFolderBatchJobStatus> Encoder = new CreateFolderBatchJobStatusEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<CreateFolderBatchJobStatus> Decoder = new CreateFolderBatchJobStatusDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="CreateFolderBatchJobStatus" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="CreateFolderBatchJobStatus" />.</para>
        /// </summary>
        private class CreateFolderBatchJobStatusEncoder : enc.StructEncoder<CreateFolderBatchJobStatus>
        {
            /// <summary>
            ...
            public override void EncodeFields(CreateFolderBatchJobStatus value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="CreateFolderBatchJobStatus" />.</para>
        /// </summary>
        private class CreateFolderBatchJobStatusDecoder : enc.UnionDecoder<CreateFolderBatchJobStatus>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="CreateFolderBatchJobStatus"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override CreateFolderBatchJobStatus Create()
            {
                return new CreateFolderBatchJobStatus();
            }
            ...
            protected override CreateFolderBatchJobStatus Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "complete":
        ...
        /// <summary>
        /// <para>The batch create folder has finished.</para>
        /// </summary>
        public sealed class Complete : CreateFolderBatchJobStatus
        {
            #pragma warning disable 108
            ...
            /// </summary>
            public CreateFolderBatchResult Value { get; private set; }
            ...
            private class CompleteEncoder : enc.StructEncoder<Complete>
            {
                ...
                {
                    WriteProperty("complete", value.Value, writer, global::Dropbox.Api.Files.CreateFolderBatchResult.Encoder);
                }
            }
            ...
            private class CompleteDecoder : enc.StructDecoder<Complete>
            {
                ...
                {
                    return new Complete(global::Dropbox.Api.Files.CreateFolderBatchResult.Decoder.DecodeFields(reader));
                }
            }
        ...
        /// <summary>
        /// <para>The batch create folder has failed.</para>
        /// </summary>
        public sealed class Failed : CreateFolderBatchJobStatus
        {
            #pragma warning disable 108
            ...
            /// </summary>
            /// <param name="value">The value</param>
            public Failed(CreateFolderBatchError value)
            {
                this.Value = value;
            }
            /// <summary>
            ...
            /// <para>Gets the value of this instance.</para>
            /// </summary>
            public CreateFolderBatchError Value { get; private set; }
            ...
            private class FailedEncoder : enc.StructEncoder<Failed>
            {
                ...
                {
                    WriteProperty("failed", value.Value, writer, global::Dropbox.Api.Files.CreateFolderBatchError.Encoder);
                }
            }
            ...
            private class FailedDecoder : enc.StructDecoder<Failed>
            {
                ...
                protected override void SetField(Failed value, string fieldName, enc.IJsonReader reader)
                {
                    ...
                    {
                        case "failed":
                            value.Value = global::Dropbox.Api.Files.CreateFolderBatchError.Decoder.Decode(reader);
                            break;
                        default:
                            reader.Skip();
                            break;
        ...
        /// </summary>
        public sealed class Other : CreateFolderBatchJobStatus
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class InProgress : CreateFolderBatchJobStatus
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Apple login policy</para>
    /// </summary>
    public class AppleLoginPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<AppleLoginPolicy> Encoder = new AppleLoginPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<AppleLoginPolicy> Decoder = new AppleLoginPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="AppleLoginPolicy" />
        /// class.</para>
        /// </summary>
        public AppleLoginPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="AppleLoginPolicy" />.</para>
        /// </summary>
        private class AppleLoginPolicyEncoder : enc.StructEncoder<AppleLoginPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(AppleLoginPolicy value, enc.IJsonWriter writer)
            {
                if (value is Default)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="AppleLoginPolicy" />.</para>
        /// </summary>
        private class AppleLoginPolicyDecoder : enc.UnionDecoder<AppleLoginPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="AppleLoginPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override AppleLoginPolicy Create()
            {
                return new AppleLoginPolicy();
            }
            ...
            protected override AppleLoginPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "default":
        ...
        /// </summary>
        public sealed class Default : AppleLoginPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Disabled : AppleLoginPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : AppleLoginPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : AppleLoginPolicy
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>File comments policy</para>
    /// </summary>
    public class FileCommentsPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<FileCommentsPolicy> Encoder = new FileCommentsPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<FileCommentsPolicy> Decoder = new FileCommentsPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="FileCommentsPolicy" />
        /// class.</para>
        /// </summary>
        public FileCommentsPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="FileCommentsPolicy" />.</para>
        /// </summary>
        private class FileCommentsPolicyEncoder : enc.StructEncoder<FileCommentsPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(FileCommentsPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="FileCommentsPolicy" />.</para>
        /// </summary>
        private class FileCommentsPolicyDecoder : enc.UnionDecoder<FileCommentsPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="FileCommentsPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override FileCommentsPolicy Create()
            {
                return new FileCommentsPolicy();
            }
            ...
            protected override FileCommentsPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : FileCommentsPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : FileCommentsPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : FileCommentsPolicy
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.TeamPolicies
{
    ...
    /// <summary>
    /// <para>The paper desktop policy object</para>
    /// </summary>
    public class PaperDesktopPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<PaperDesktopPolicy> Encoder = new PaperDesktopPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<PaperDesktopPolicy> Decoder = new PaperDesktopPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="PaperDesktopPolicy" />
        /// class.</para>
        /// </summary>
        public PaperDesktopPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="PaperDesktopPolicy" />.</para>
        /// </summary>
        private class PaperDesktopPolicyEncoder : enc.StructEncoder<PaperDesktopPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(PaperDesktopPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="PaperDesktopPolicy" />.</para>
        /// </summary>
        private class PaperDesktopPolicyDecoder : enc.UnionDecoder<PaperDesktopPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="PaperDesktopPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override PaperDesktopPolicy Create()
            {
                return new PaperDesktopPolicy();
            }
            ...
            protected override PaperDesktopPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// <summary>
        /// <para>Do not allow team members to use Paper Desktop.</para>
        /// </summary>
        public sealed class Disabled : PaperDesktopPolicy
        {
            #pragma warning disable 108
        ...
        /// <summary>
        /// <para>Allow team members to use Paper Desktop.</para>
        /// </summary>
        public sealed class Enabled : PaperDesktopPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : PaperDesktopPolicy
        {
            #pragma warning disable 108

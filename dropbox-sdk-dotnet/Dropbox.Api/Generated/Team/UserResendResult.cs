...
namespace Dropbox.Api.Team
{
    ...
    public class UserResendResult
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<UserResendResult> Encoder = new UserResendResultEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<UserResendResult> Decoder = new UserResendResultDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="UserResendResult" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="UserResendResult" />.</para>
        /// </summary>
        private class UserResendResultEncoder : enc.StructEncoder<UserResendResult>
        {
            /// <summary>
            ...
            public override void EncodeFields(UserResendResult value, enc.IJsonWriter writer)
            {
                if (value is Success)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="UserResendResult" />.</para>
        /// </summary>
        private class UserResendResultDecoder : enc.UnionDecoder<UserResendResult>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="UserResendResult" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override UserResendResult Create()
            {
                return new UserResendResult();
            }
            ...
            protected override UserResendResult Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "success":
        ...
        /// <summary>
        /// <para>Describes a user and the results for each attempt to resend verification
        /// emails.</para>
        /// </summary>
        public sealed class Success : UserResendResult
        {
            #pragma warning disable 108
            ...
            /// </summary>
            /// <param name="value">The value</param>
            public Success(UserResendEmailsResult value)
            {
                this.Value = value;
            }
            /// <summary>
            ...
            /// </summary>
            public UserResendEmailsResult Value { get; private set; }
            ...
            private class SuccessEncoder : enc.StructEncoder<Success>
            {
                ...
                {
                    WriteProperty("success", value.Value, writer, global::Dropbox.Api.Team.UserResendEmailsResult.Encoder);
                }
            }
            ...
            private class SuccessDecoder : enc.StructDecoder<Success>
            {
                ...
                {
                    return new Success(global::Dropbox.Api.Team.UserResendEmailsResult.Decoder.DecodeFields(reader));
                }
            }
        ...
        /// <summary>
        /// <para>Specified user is not a valid target for resending verification
        /// emails.</para>
        /// </summary>
        public sealed class InvalidUser : UserResendResult
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : UserResendResult
        {
            #pragma warning disable 108

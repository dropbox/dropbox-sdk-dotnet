...
namespace Dropbox.Api.Riviera
{
    ...
    /// <summary>
    /// <para>Status of a metadata extraction job started by <see
    /// cref="Dropbox.Api.Riviera.Routes.RivieraAppRoutes.GetMetadataAsyncAsync" /> <see
    /// cref="Dropbox.Api.Riviera.Routes.RivieraUserRoutes.GetMetadataAsyncAsync" />, as
    /// returned by <see
    /// cref="Dropbox.Api.Riviera.Routes.RivieraAppRoutes.GetMetadataAsyncCheckAsync" /> <see
    /// cref="Dropbox.Api.Riviera.Routes.RivieraUserRoutes.GetMetadataAsyncCheckAsync"
    /// />.</para>
    /// </summary>
    public class GetMetadataAsyncCheckResult
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<GetMetadataAsyncCheckResult> Encoder = new GetMetadataAsyncCheckResultEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<GetMetadataAsyncCheckResult> Decoder = new GetMetadataAsyncCheckResultDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="GetMetadataAsyncCheckResult" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="GetMetadataAsyncCheckResult" />.</para>
        /// </summary>
        private class GetMetadataAsyncCheckResultEncoder : enc.StructEncoder<GetMetadataAsyncCheckResult>
        {
            /// <summary>
            ...
            public override void EncodeFields(GetMetadataAsyncCheckResult value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="GetMetadataAsyncCheckResult" />.</para>
        /// </summary>
        private class GetMetadataAsyncCheckResultDecoder : enc.UnionDecoder<GetMetadataAsyncCheckResult>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="GetMetadataAsyncCheckResult"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override GetMetadataAsyncCheckResult Create()
            {
                return new GetMetadataAsyncCheckResult();
            }
            ...
            protected override GetMetadataAsyncCheckResult Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "in_progress":
        ...
        /// </summary>
        public sealed class InProgress : GetMetadataAsyncCheckResult
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Complete : GetMetadataAsyncCheckResult
        {
            #pragma warning disable 108
            ...
            /// </summary>
            public GetMetadataResult Value { get; private set; }
            ...
            private class CompleteEncoder : enc.StructEncoder<Complete>
            {
                ...
                {
                    WriteProperty("complete", value.Value, writer, global::Dropbox.Api.Riviera.GetMetadataResult.Encoder);
                }
            }
            ...
            private class CompleteDecoder : enc.StructDecoder<Complete>
            {
                ...
                {
                    return new Complete(global::Dropbox.Api.Riviera.GetMetadataResult.Decoder.DecodeFields(reader));
                }
            }
        ...
        /// </summary>
        public sealed class Failed : GetMetadataAsyncCheckResult
        {
            #pragma warning disable 108
            ...
            /// </summary>
            /// <param name="value">The value</param>
            public Failed(MetadataExtractionApiV2Error value)
            {
                this.Value = value;
            }
            /// <summary>
            ...
            /// <para>Gets the value of this instance.</para>
            /// </summary>
            public MetadataExtractionApiV2Error Value { get; private set; }
            ...
            private class FailedEncoder : enc.StructEncoder<Failed>
            {
                ...
                {
                    WriteProperty("failed", value.Value, writer, global::Dropbox.Api.Riviera.MetadataExtractionApiV2Error.Encoder);
                }
            }
            ...
            private class FailedDecoder : enc.StructDecoder<Failed>
            {
                ...
                protected override void SetField(Failed value, string fieldName, enc.IJsonReader reader)
                {
                    ...
                    {
                        case "failed":
                            value.Value = global::Dropbox.Api.Riviera.MetadataExtractionApiV2Error.Decoder.Decode(reader);
                            break;
                        default:
                            reader.Skip();
                            break;
        ...
        /// </summary>
        public sealed class Other : GetMetadataAsyncCheckResult
        {
            #pragma warning disable 108

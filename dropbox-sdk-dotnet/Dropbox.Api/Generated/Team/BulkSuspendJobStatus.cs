...
namespace Dropbox.Api.Team
{
    ...
    /// <summary>
    /// <para>Coarse job state. Live row progress and report contents are intentionally
    /// omitted; callers receive row details in the terminal email report.</para>
    /// </summary>
    public class BulkSuspendJobStatus
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<BulkSuspendJobStatus> Encoder = new BulkSuspendJobStatusEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<BulkSuspendJobStatus> Decoder = new BulkSuspendJobStatusDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="BulkSuspendJobStatus" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="BulkSuspendJobStatus" />.</para>
        /// </summary>
        private class BulkSuspendJobStatusEncoder : enc.StructEncoder<BulkSuspendJobStatus>
        {
            /// <summary>
            ...
            public override void EncodeFields(BulkSuspendJobStatus value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="BulkSuspendJobStatus" />.</para>
        /// </summary>
        private class BulkSuspendJobStatusDecoder : enc.UnionDecoder<BulkSuspendJobStatus>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="BulkSuspendJobStatus" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override BulkSuspendJobStatus Create()
            {
                return new BulkSuspendJobStatus();
            }
            ...
            protected override BulkSuspendJobStatus Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "complete":
        ...
        /// </summary>
        public sealed class Complete : BulkSuspendJobStatus
        {
            #pragma warning disable 108
            ...
            /// </summary>
            public BulkSuspendComplete Value { get; private set; }
            ...
            private class CompleteEncoder : enc.StructEncoder<Complete>
            {
                ...
                {
                    WriteProperty("complete", value.Value, writer, global::Dropbox.Api.Team.BulkSuspendComplete.Encoder);
                }
            }
            ...
            private class CompleteDecoder : enc.StructDecoder<Complete>
            {
                ...
                {
                    return new Complete(global::Dropbox.Api.Team.BulkSuspendComplete.Decoder.DecodeFields(reader));
                }
            }
        ...
        /// </summary>
        public sealed class Failed : BulkSuspendJobStatus
        {
            #pragma warning disable 108
            ...
            /// <para>Gets the value of this instance.</para>
            /// </summary>
            public BulkSuspendTaskFailure Value { get; private set; }
            ...
            private class FailedEncoder : enc.StructEncoder<Failed>
            {
                ...
                {
                    WriteProperty("failed", value.Value, writer, global::Dropbox.Api.Team.BulkSuspendTaskFailure.Encoder);
                }
            }
            ...
            private class FailedDecoder : enc.StructDecoder<Failed>
            {
                ...
                protected override void SetField(Failed value, string fieldName, enc.IJsonReader reader)
                {
                    ...
                    {
                        case "failed":
                            value.Value = global::Dropbox.Api.Team.BulkSuspendTaskFailure.Decoder.Decode(reader);
                            break;
                        default:
                            reader.Skip();
                            break;
        ...
        /// </summary>
        public sealed class Other : BulkSuspendJobStatus
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class InProgress : BulkSuspendJobStatus
        {
            #pragma warning disable 108

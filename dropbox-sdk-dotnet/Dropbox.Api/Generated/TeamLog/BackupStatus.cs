...
namespace Dropbox.Api.TeamLog
{
    ...
    public class BackupStatus
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<BackupStatus> Encoder = new BackupStatusEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<BackupStatus> Decoder = new BackupStatusDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="BackupStatus" /> class.</para>
        /// </summary>
        public BackupStatus()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="BackupStatus" />.</para>
        /// </summary>
        private class BackupStatusEncoder : enc.StructEncoder<BackupStatus>
        {
            /// <summary>
            ...
            public override void EncodeFields(BackupStatus value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="BackupStatus" />.</para>
        /// </summary>
        private class BackupStatusDecoder : enc.UnionDecoder<BackupStatus>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="BackupStatus" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override BackupStatus Create()
            {
            ...
            protected override BackupStatus Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : BackupStatus
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : BackupStatus
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : BackupStatus
        {
            #pragma warning disable 108

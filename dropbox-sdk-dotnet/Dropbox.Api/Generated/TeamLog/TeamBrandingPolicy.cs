...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for controlling team access to setting up branding feature</para>
    /// </summary>
    public class TeamBrandingPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<TeamBrandingPolicy> Encoder = new TeamBrandingPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<TeamBrandingPolicy> Decoder = new TeamBrandingPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="TeamBrandingPolicy" />
        /// class.</para>
        /// </summary>
        public TeamBrandingPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="TeamBrandingPolicy" />.</para>
        /// </summary>
        private class TeamBrandingPolicyEncoder : enc.StructEncoder<TeamBrandingPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(TeamBrandingPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="TeamBrandingPolicy" />.</para>
        /// </summary>
        private class TeamBrandingPolicyDecoder : enc.UnionDecoder<TeamBrandingPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="TeamBrandingPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override TeamBrandingPolicy Create()
            {
                return new TeamBrandingPolicy();
            }
            ...
            protected override TeamBrandingPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : TeamBrandingPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : TeamBrandingPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : TeamBrandingPolicy
        {
            #pragma warning disable 108

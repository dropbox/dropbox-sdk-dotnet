...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for controlling if reseller can access the admin console as
    /// administrator</para>
    /// </summary>
    public class ResellerSupportPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<ResellerSupportPolicy> Encoder = new ResellerSupportPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<ResellerSupportPolicy> Decoder = new ResellerSupportPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="ResellerSupportPolicy" />
        /// class.</para>
        /// </summary>
        public ResellerSupportPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="ResellerSupportPolicy" />.</para>
        /// </summary>
        private class ResellerSupportPolicyEncoder : enc.StructEncoder<ResellerSupportPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(ResellerSupportPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="ResellerSupportPolicy" />.</para>
        /// </summary>
        private class ResellerSupportPolicyDecoder : enc.UnionDecoder<ResellerSupportPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="ResellerSupportPolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override ResellerSupportPolicy Create()
            {
                return new ResellerSupportPolicy();
            }
            ...
            protected override ResellerSupportPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : ResellerSupportPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : ResellerSupportPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : ResellerSupportPolicy
        {
            #pragma warning disable 108

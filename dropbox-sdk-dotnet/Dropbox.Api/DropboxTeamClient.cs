...
namespace Dropbox.Api
{
    ...
    public sealed partial class DropboxTeamClient : DropboxClientBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DropboxTeamClient"/> class.
        /// </summary>
        ...
        private DropboxTeamClient(DropboxRequestHandlerOptions options)
            : this(options, new DropboxRequestHandler(options))
        {
        }
        ...
        private DropboxTeamClient(DropboxRequestHandlerOptions options, DropboxRequestHandler requestHandler)
            : base(requestHandler)
        {

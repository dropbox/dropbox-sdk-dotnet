...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>The enable disable change policy object</para>
    /// </summary>
    public class EnableDisableChangePolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<EnableDisableChangePolicy> Encoder = new EnableDisableChangePolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<EnableDisableChangePolicy> Decoder = new EnableDisableChangePolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="EnableDisableChangePolicy" />
        /// class.</para>
        /// </summary>
        public EnableDisableChangePolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="EnableDisableChangePolicy" />.</para>
        /// </summary>
        private class EnableDisableChangePolicyEncoder : enc.StructEncoder<EnableDisableChangePolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(EnableDisableChangePolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="EnableDisableChangePolicy" />.</para>
        /// </summary>
        private class EnableDisableChangePolicyDecoder : enc.UnionDecoder<EnableDisableChangePolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="EnableDisableChangePolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override EnableDisableChangePolicy Create()
            {
                return new EnableDisableChangePolicy();
            }
            ...
            protected override EnableDisableChangePolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : EnableDisableChangePolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : EnableDisableChangePolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : EnableDisableChangePolicy
        {
            #pragma warning disable 108

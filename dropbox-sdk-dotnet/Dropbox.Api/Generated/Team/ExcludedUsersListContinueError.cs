...
namespace Dropbox.Api.Team
{
    ...
    /// <summary>
    /// <para>Excluded users list continue error.</para>
    /// </summary>
    public class ExcludedUsersListContinueError
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<ExcludedUsersListContinueError> Encoder = new ExcludedUsersListContinueErrorEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<ExcludedUsersListContinueError> Decoder = new ExcludedUsersListContinueErrorDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="ExcludedUsersListContinueError"
        /// /> class.</para>
        /// </summary>
        public ExcludedUsersListContinueError()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="ExcludedUsersListContinueError" />.</para>
        /// </summary>
        private class ExcludedUsersListContinueErrorEncoder : enc.StructEncoder<ExcludedUsersListContinueError>
        {
            /// <summary>
            ...
            public override void EncodeFields(ExcludedUsersListContinueError value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="ExcludedUsersListContinueError" />.</para>
        /// </summary>
        private class ExcludedUsersListContinueErrorDecoder : enc.UnionDecoder<ExcludedUsersListContinueError>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="ExcludedUsersListContinueError"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override ExcludedUsersListContinueError Create()
            {
                return new ExcludedUsersListContinueError();
            }
            ...
            protected override ExcludedUsersListContinueError Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "invalid_cursor":
        ...
        /// </summary>
        public sealed class InvalidCursor : ExcludedUsersListContinueError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : ExcludedUsersListContinueError
        {
            #pragma warning disable 108

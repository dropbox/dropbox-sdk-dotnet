...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for controlling whether team selective sync is enabled for team.</para>
    /// </summary>
    public class TeamSelectiveSyncPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<TeamSelectiveSyncPolicy> Encoder = new TeamSelectiveSyncPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<TeamSelectiveSyncPolicy> Decoder = new TeamSelectiveSyncPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="TeamSelectiveSyncPolicy" />
        /// class.</para>
        /// </summary>
        public TeamSelectiveSyncPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="TeamSelectiveSyncPolicy" />.</para>
        /// </summary>
        private class TeamSelectiveSyncPolicyEncoder : enc.StructEncoder<TeamSelectiveSyncPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(TeamSelectiveSyncPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="TeamSelectiveSyncPolicy" />.</para>
        /// </summary>
        private class TeamSelectiveSyncPolicyDecoder : enc.UnionDecoder<TeamSelectiveSyncPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="TeamSelectiveSyncPolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override TeamSelectiveSyncPolicy Create()
            {
                return new TeamSelectiveSyncPolicy();
            }
            ...
            protected override TeamSelectiveSyncPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : TeamSelectiveSyncPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : TeamSelectiveSyncPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : TeamSelectiveSyncPolicy
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for controlling if team members can create templates</para>
    /// </summary>
    public class SignTemplateCreationPermissionPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<SignTemplateCreationPermissionPolicy> Encoder = new SignTemplateCreationPermissionPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<SignTemplateCreationPermissionPolicy> Decoder = new SignTemplateCreationPermissionPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see
        /// cref="SignTemplateCreationPermissionPolicy" /> class.</para>
        /// </summary>
        public SignTemplateCreationPermissionPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="SignTemplateCreationPermissionPolicy" />.</para>
        /// </summary>
        private class SignTemplateCreationPermissionPolicyEncoder : enc.StructEncoder<SignTemplateCreationPermissionPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(SignTemplateCreationPermissionPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="SignTemplateCreationPermissionPolicy" />.</para>
        /// </summary>
        private class SignTemplateCreationPermissionPolicyDecoder : enc.UnionDecoder<SignTemplateCreationPermissionPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see
            /// cref="SignTemplateCreationPermissionPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override SignTemplateCreationPermissionPolicy Create()
            {
                return new SignTemplateCreationPermissionPolicy();
            }
            ...
            protected override SignTemplateCreationPermissionPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : SignTemplateCreationPermissionPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : SignTemplateCreationPermissionPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : SignTemplateCreationPermissionPolicy
        {
            #pragma warning disable 108

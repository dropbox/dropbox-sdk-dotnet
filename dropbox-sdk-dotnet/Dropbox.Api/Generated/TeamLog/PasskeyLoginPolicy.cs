...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Passkey login policy</para>
    /// </summary>
    public class PasskeyLoginPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<PasskeyLoginPolicy> Encoder = new PasskeyLoginPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<PasskeyLoginPolicy> Decoder = new PasskeyLoginPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="PasskeyLoginPolicy" />
        /// class.</para>
        /// </summary>
        public PasskeyLoginPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="PasskeyLoginPolicy" />.</para>
        /// </summary>
        private class PasskeyLoginPolicyEncoder : enc.StructEncoder<PasskeyLoginPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(PasskeyLoginPolicy value, enc.IJsonWriter writer)
            {
                if (value is Default)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="PasskeyLoginPolicy" />.</para>
        /// </summary>
        private class PasskeyLoginPolicyDecoder : enc.UnionDecoder<PasskeyLoginPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="PasskeyLoginPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override PasskeyLoginPolicy Create()
            {
                return new PasskeyLoginPolicy();
            }
            ...
            protected override PasskeyLoginPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "default":
        ...
        /// </summary>
        public sealed class Default : PasskeyLoginPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Disabled : PasskeyLoginPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : PasskeyLoginPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : PasskeyLoginPolicy
        {
            #pragma warning disable 108

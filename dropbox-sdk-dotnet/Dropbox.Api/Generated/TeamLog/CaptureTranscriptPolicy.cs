...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for deciding whether team users can transcription in Capture</para>
    /// </summary>
    public class CaptureTranscriptPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<CaptureTranscriptPolicy> Encoder = new CaptureTranscriptPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<CaptureTranscriptPolicy> Decoder = new CaptureTranscriptPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="CaptureTranscriptPolicy" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="CaptureTranscriptPolicy" />.</para>
        /// </summary>
        private class CaptureTranscriptPolicyEncoder : enc.StructEncoder<CaptureTranscriptPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(CaptureTranscriptPolicy value, enc.IJsonWriter writer)
            {
                if (value is Default)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="CaptureTranscriptPolicy" />.</para>
        /// </summary>
        private class CaptureTranscriptPolicyDecoder : enc.UnionDecoder<CaptureTranscriptPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="CaptureTranscriptPolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override CaptureTranscriptPolicy Create()
            {
                return new CaptureTranscriptPolicy();
            }
            ...
            protected override CaptureTranscriptPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "default":
        ...
        /// </summary>
        public sealed class Default : CaptureTranscriptPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Disabled : CaptureTranscriptPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : CaptureTranscriptPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : CaptureTranscriptPolicy
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for deciding whether team users can share Dash content externally</para>
    /// </summary>
    public class DashExternalSharingPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<DashExternalSharingPolicy> Encoder = new DashExternalSharingPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<DashExternalSharingPolicy> Decoder = new DashExternalSharingPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="DashExternalSharingPolicy" />
        /// class.</para>
        /// </summary>
        public DashExternalSharingPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="DashExternalSharingPolicy" />.</para>
        /// </summary>
        private class DashExternalSharingPolicyEncoder : enc.StructEncoder<DashExternalSharingPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(DashExternalSharingPolicy value, enc.IJsonWriter writer)
            {
                if (value is Default)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="DashExternalSharingPolicy" />.</para>
        /// </summary>
        private class DashExternalSharingPolicyDecoder : enc.UnionDecoder<DashExternalSharingPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="DashExternalSharingPolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override DashExternalSharingPolicy Create()
            {
                return new DashExternalSharingPolicy();
            }
            ...
            protected override DashExternalSharingPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "default":
        ...
        /// </summary>
        public sealed class Default : DashExternalSharingPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Disabled : DashExternalSharingPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : DashExternalSharingPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : DashExternalSharingPolicy
        {
            #pragma warning disable 108

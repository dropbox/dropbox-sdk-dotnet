...
namespace Dropbox.Api.TeamPolicies
{
    ...
    /// <summary>
    /// <para>The smarter smart sync policy state object</para>
    /// </summary>
    public class SmarterSmartSyncPolicyState
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<SmarterSmartSyncPolicyState> Encoder = new SmarterSmartSyncPolicyStateEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<SmarterSmartSyncPolicyState> Decoder = new SmarterSmartSyncPolicyStateDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="SmarterSmartSyncPolicyState" />
        /// class.</para>
        /// </summary>
        public SmarterSmartSyncPolicyState()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="SmarterSmartSyncPolicyState" />.</para>
        /// </summary>
        private class SmarterSmartSyncPolicyStateEncoder : enc.StructEncoder<SmarterSmartSyncPolicyState>
        {
            /// <summary>
            ...
            public override void EncodeFields(SmarterSmartSyncPolicyState value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="SmarterSmartSyncPolicyState" />.</para>
        /// </summary>
        private class SmarterSmartSyncPolicyStateDecoder : enc.UnionDecoder<SmarterSmartSyncPolicyState>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="SmarterSmartSyncPolicyState"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override SmarterSmartSyncPolicyState Create()
            {
                return new SmarterSmartSyncPolicyState();
            }
            ...
            protected override SmarterSmartSyncPolicyState Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// <summary>
        /// <para>Smarter Smart Sync feature is disabled.</para>
        /// </summary>
        public sealed class Disabled : SmarterSmartSyncPolicyState
        {
            #pragma warning disable 108
        ...
        /// <summary>
        /// <para>Smarter Smart Sync feature is enabled.</para>
        /// </summary>
        public sealed class Enabled : SmarterSmartSyncPolicyState
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : SmarterSmartSyncPolicyState
        {
            #pragma warning disable 108

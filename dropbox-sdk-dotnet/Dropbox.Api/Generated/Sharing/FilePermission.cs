...
namespace Dropbox.Api.Sharing
{
    ...
    public class FilePermission
    {
        ...
        private class FilePermissionEncoder : enc.StructEncoder<FilePermission>
        {
            ...
            {
                WriteProperty("action", value.Action, writer, global::Dropbox.Api.Sharing.FileAction.Encoder);
        ...
        private class FilePermissionDecoder : enc.StructDecoder<FilePermission>
        {
            ...
            protected override void SetField(FilePermission value, string fieldName, enc.IJsonReader reader)
            {
                ...
                {
                    case "action":
                        value.Action = global::Dropbox.Api.Sharing.FileAction.Decoder.Decode(reader);
                        break;
                    case "allow":

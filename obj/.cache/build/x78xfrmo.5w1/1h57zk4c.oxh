  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><p sourcefile="gh-pages/obj/api/Dropbox.Api.Files.FileMetadata.yml" sourcestartlinenumber="1" sourceendlinenumber="2">The last component of the path (including extension). This never
contains a slash.</p>
</td>
      </tr>
      <tr>
        ...
        <td><p sourcefile="gh-pages/obj/api/Dropbox.Api.Files.FileMetadata.yml" sourcestartlinenumber="1" sourceendlinenumber="1">A unique identifier for the file.</p>
</td>
      </tr>
      <tr>
        <td><span class="xref">System.DateTime</span></td>
        <td><span class="parametername">clientModified</span></td>
        <td><p sourcefile="gh-pages/obj/api/Dropbox.Api.Files.FileMetadata.yml" sourcestartlinenumber="1" sourceendlinenumber="5">For files, this is the modification time set by the
...
if a file has changed or not.</p>
      ...
      <tr>
        ...
        <td><p sourcefile="gh-pages/obj/api/Dropbox.Api.Files.FileMetadata.yml" sourcestartlinenumber="1" sourceendlinenumber="2">The last time the file was modified on
Dropbox.</p>
</td>
      </tr>
      <tr>
        ...
        <td><p sourcefile="gh-pages/obj/api/Dropbox.Api.Files.FileMetadata.yml" sourcestartlinenumber="1" sourceendlinenumber="3">A unique identifier for the current revision of a file. This
...
avoid conflicts.</p>
      ...
      <tr>
        ...
        <td><p sourcefile="gh-pages/obj/api/Dropbox.Api.Files.FileMetadata.yml" sourcestartlinenumber="1" sourceendlinenumber="1">The file size in bytes.</p>
</td>
      </tr>
      <tr>
        <td><span class="xref">System.String</span></td>
        <td><span class="parametername">pathLower</span></td>
        <td><p sourcefile="gh-pages/obj/api/Dropbox.Api.Files.FileMetadata.yml" sourcestartlinenumber="1" sourceendlinenumber="3">The lowercased full path in the user&apos;s Dropbox. This always
...
mounted.</p>
      ...
      <tr>
        ...
        <td><p sourcefile="gh-pages/obj/api/Dropbox.Api.Files.FileMetadata.yml" sourcestartlinenumber="1" sourceendlinenumber="6">The cased path to be used for display purposes only. In
...
field will be null if the file or folder is not mounted.</p>
      ...
      <tr>
        ...
        <td><p sourcefile="gh-pages/obj/api/Dropbox.Api.Files.FileMetadata.yml" sourcestartlinenumber="1" sourceendlinenumber="1">Please use <a class="xref" href="Dropbox.Api.Files.FileSharingInfo.html#Dropbox_Api_Files_FileSharingInfo_ParentSharedFolderId">ParentSharedFolderId</a> or <a class="xref" href="Dropbox.Api.Files.FolderSharingInfo.html#Dropbox_Api_Files_FolderSharingInfo_ParentSharedFolderId">ParentSharedFolderId</a> instead.</p>
</td>
      </tr>
      <tr>
        <td><span class="xref">System.String</span></td>
        <td><span class="parametername">previewUrl</span></td>
        <td><p sourcefile="gh-pages/obj/api/Dropbox.Api.Files.FileMetadata.yml" sourcestartlinenumber="1" sourceendlinenumber="1">The preview URL of the file.</p>
</td>
      </tr>
      <tr>
        <td><a class="xref" href="Dropbox.Api.Files.MediaInfo.html">MediaInfo</a></td>
        <td><span class="parametername">mediaInfo</span></td>
        <td><p sourcefile="gh-pages/obj/api/Dropbox.Api.Files.FileMetadata.yml" sourcestartlinenumber="1" sourceendlinenumber="3">Additional information if the file is a photo or video.
...
December 2, 2019.</p>
      ...
      <tr>
        ...
        <td><p sourcefile="gh-pages/obj/api/Dropbox.Api.Files.FileMetadata.yml" sourcestartlinenumber="1" sourceendlinenumber="1">Set if this file is a symlink.</p>
</td>
      </tr>
      <tr>
        ...
        <td><p sourcefile="gh-pages/obj/api/Dropbox.Api.Files.FileMetadata.yml" sourcestartlinenumber="1" sourceendlinenumber="1">Set if this file is contained in a shared folder.</p>
</td>
      </tr>
      <tr>
        <td><span class="xref">System.Boolean</span></td>
        <td><span class="parametername">isDownloadable</span></td>
        <td><p sourcefile="gh-pages/obj/api/Dropbox.Api.Files.FileMetadata.yml" sourcestartlinenumber="1" sourceendlinenumber="2">If true, file can be downloaded directly; else the
file must be exported.</p>
      ...
      <tr>
        ...
        <td><p sourcefile="gh-pages/obj/api/Dropbox.Api.Files.FileMetadata.yml" sourcestartlinenumber="1" sourceendlinenumber="3">Information about format this file can be exported to.
...
false.</p>
      ...
      <tr>
        ...
        <td><p sourcefile="gh-pages/obj/api/Dropbox.Api.Files.FileMetadata.yml" sourcestartlinenumber="1" sourceendlinenumber="2">Additional information if the file has custom
properties with the property template specified.</p>
      ...
      <tr>
        ...
        <td><p sourcefile="gh-pages/obj/api/Dropbox.Api.Files.FileMetadata.yml" sourcestartlinenumber="1" sourceendlinenumber="5">This flag will only be present if
...
has explicit members but is not contained within  a shared folder.</p>
      ...
      <tr>
        ...
        <td><p sourcefile="gh-pages/obj/api/Dropbox.Api.Files.FileMetadata.yml" sourcestartlinenumber="1" sourceendlinenumber="3">A hash of the file content. This field can be used to
...
page.</p>
      ...
      <tr>
        ...
        <td><p sourcefile="gh-pages/obj/api/Dropbox.Api.Files.FileMetadata.yml" sourcestartlinenumber="1" sourceendlinenumber="2">If present, the metadata associated with the file&apos;s
current lock.</p>
</td>
      </tr>
    </tbody>

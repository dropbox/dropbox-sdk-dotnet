...
namespace Dropbox.Api.Files
{
    ...
    /// <summary>
    /// <para>The create folder entry error object</para>
    /// </summary>
    public class CreateFolderEntryError
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<CreateFolderEntryError> Encoder = new CreateFolderEntryErrorEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<CreateFolderEntryError> Decoder = new CreateFolderEntryErrorDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="CreateFolderEntryError" />
        /// class.</para>
        /// </summary>
        public CreateFolderEntryError()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="CreateFolderEntryError" />.</para>
        /// </summary>
        private class CreateFolderEntryErrorEncoder : enc.StructEncoder<CreateFolderEntryError>
        {
            /// <summary>
            ...
            public override void EncodeFields(CreateFolderEntryError value, enc.IJsonWriter writer)
            {
                if (value is Path)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="CreateFolderEntryError" />.</para>
        /// </summary>
        private class CreateFolderEntryErrorDecoder : enc.UnionDecoder<CreateFolderEntryError>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="CreateFolderEntryError"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override CreateFolderEntryError Create()
            {
                return new CreateFolderEntryError();
            }
            ...
            protected override CreateFolderEntryError Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "path":
        ...
        /// </summary>
        public sealed class Path : CreateFolderEntryError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : CreateFolderEntryError
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for deciding whether team users have access to the Capture team
    /// space</para>
    /// </summary>
    public class CaptureTeamSpacePolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<CaptureTeamSpacePolicy> Encoder = new CaptureTeamSpacePolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<CaptureTeamSpacePolicy> Decoder = new CaptureTeamSpacePolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="CaptureTeamSpacePolicy" />
        /// class.</para>
        /// </summary>
        public CaptureTeamSpacePolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="CaptureTeamSpacePolicy" />.</para>
        /// </summary>
        private class CaptureTeamSpacePolicyEncoder : enc.StructEncoder<CaptureTeamSpacePolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(CaptureTeamSpacePolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="CaptureTeamSpacePolicy" />.</para>
        /// </summary>
        private class CaptureTeamSpacePolicyDecoder : enc.UnionDecoder<CaptureTeamSpacePolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="CaptureTeamSpacePolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override CaptureTeamSpacePolicy Create()
            {
                return new CaptureTeamSpacePolicy();
            }
            ...
            protected override CaptureTeamSpacePolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : CaptureTeamSpacePolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : CaptureTeamSpacePolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : CaptureTeamSpacePolicy
        {
            #pragma warning disable 108

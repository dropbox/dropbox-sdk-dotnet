...
namespace Dropbox.Api.FileRequests
{
    ...
    public class ListFileRequestsContinueError
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<ListFileRequestsContinueError> Encoder = new ListFileRequestsContinueErrorEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<ListFileRequestsContinueError> Decoder = new ListFileRequestsContinueErrorDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="ListFileRequestsContinueError"
        /// /> class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="ListFileRequestsContinueError" />.</para>
        /// </summary>
        private class ListFileRequestsContinueErrorEncoder : enc.StructEncoder<ListFileRequestsContinueError>
        {
            /// <summary>
            ...
            public override void EncodeFields(ListFileRequestsContinueError value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="ListFileRequestsContinueError" />.</para>
        /// </summary>
        private class ListFileRequestsContinueErrorDecoder : enc.UnionDecoder<ListFileRequestsContinueError>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="ListFileRequestsContinueError"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override ListFileRequestsContinueError Create()
            {
                return new ListFileRequestsContinueError();
            }
            ...
            protected override ListFileRequestsContinueError Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "invalid_cursor":
        ...
        /// </summary>
        public sealed class InvalidCursor : ListFileRequestsContinueError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class DisabledForTeam : ListFileRequestsContinueError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : ListFileRequestsContinueError
        {
            #pragma warning disable 108

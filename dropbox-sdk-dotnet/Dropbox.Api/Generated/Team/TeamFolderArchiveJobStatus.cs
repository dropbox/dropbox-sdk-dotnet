...
namespace Dropbox.Api.Team
{
    ...
    /// <summary>
    /// <para>The team folder archive job status object</para>
    /// </summary>
    public class TeamFolderArchiveJobStatus
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<TeamFolderArchiveJobStatus> Encoder = new TeamFolderArchiveJobStatusEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<TeamFolderArchiveJobStatus> Decoder = new TeamFolderArchiveJobStatusDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="TeamFolderArchiveJobStatus" />
        /// class.</para>
        /// </summary>
        public TeamFolderArchiveJobStatus()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="TeamFolderArchiveJobStatus" />.</para>
        /// </summary>
        private class TeamFolderArchiveJobStatusEncoder : enc.StructEncoder<TeamFolderArchiveJobStatus>
        {
            /// <summary>
            ...
            public override void EncodeFields(TeamFolderArchiveJobStatus value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="TeamFolderArchiveJobStatus" />.</para>
        /// </summary>
        private class TeamFolderArchiveJobStatusDecoder : enc.UnionDecoder<TeamFolderArchiveJobStatus>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="TeamFolderArchiveJobStatus"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override TeamFolderArchiveJobStatus Create()
            {
                return new TeamFolderArchiveJobStatus();
            }
            ...
            protected override TeamFolderArchiveJobStatus Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "complete":
        ...
        /// <summary>
        /// <para>The archive job has finished. The value is the metadata for the resulting
        /// team folder.</para>
        /// </summary>
        public sealed class Complete : TeamFolderArchiveJobStatus
        {
            #pragma warning disable 108
            ...
            /// </summary>
            /// <param name="value">The value</param>
            public Complete(TeamFolderMetadata value)
            {
                this.Value = value;
            }
            /// <summary>
            ...
            /// </summary>
            public TeamFolderMetadata Value { get; private set; }
            ...
            private class CompleteEncoder : enc.StructEncoder<Complete>
            {
                ...
                {
                    WriteProperty("complete", value.Value, writer, global::Dropbox.Api.Team.TeamFolderMetadata.Encoder);
                }
            }
        ...
        /// cref="Dropbox.Api.Team.Routes.TeamTeamRoutes.TeamFolderArchiveAsync" />.</para>
        /// </summary>
        public sealed class Failed : TeamFolderArchiveJobStatus
        {
            #pragma warning disable 108
            ...
            /// </summary>
            /// <param name="value">The value</param>
            public Failed(TeamFolderArchiveError value)
            {
                this.Value = value;
            }
            /// <summary>
            ...
            /// <para>Gets the value of this instance.</para>
            /// </summary>
            public TeamFolderArchiveError Value { get; private set; }
            ...
            private class FailedEncoder : enc.StructEncoder<Failed>
            {
                ...
                {
                    WriteProperty("failed", value.Value, writer, global::Dropbox.Api.Team.TeamFolderArchiveError.Encoder);
                }
            }
        ...
        /// </summary>
        public sealed class InProgress : TeamFolderArchiveJobStatus
        {
            #pragma warning disable 108

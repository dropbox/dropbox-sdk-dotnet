...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Enterprise mobility management policy</para>
    /// </summary>
    public class EmmPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<EmmPolicy> Encoder = new EmmPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<EmmPolicy> Decoder = new EmmPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="EmmPolicy" /> class.</para>
        /// </summary>
        public EmmPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="EmmPolicy" />.</para>
        /// </summary>
        private class EmmPolicyEncoder : enc.StructEncoder<EmmPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(EmmPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="EmmPolicy" />.</para>
        /// </summary>
        private class EmmPolicyDecoder : enc.UnionDecoder<EmmPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="EmmPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override EmmPolicy Create()
            {
                return new EmmPolicy();
            }
            ...
            protected override EmmPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : EmmPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Optional : EmmPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Required : EmmPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : EmmPolicy
        {
            #pragma warning disable 108

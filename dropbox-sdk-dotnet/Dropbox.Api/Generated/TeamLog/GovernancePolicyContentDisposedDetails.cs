...
namespace Dropbox.Api.TeamLog
{
    ...
    public class GovernancePolicyContentDisposedDetails
    {
        ...
        public GovernancePolicyContentDisposedDetails(string governancePolicyId,
                                                      string name,
                                                      ...
                                                      PolicyType policyType = null)
        {
            ...
            {
                throw new sys.ArgumentNullException("dispositionType");
            }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="GovernancePolicyContentDisposedDetails" />.</para>
        /// </summary>
        private class GovernancePolicyContentDisposedDetailsEncoder : enc.StructEncoder<GovernancePolicyContentDisposedDetails>
        {
            ...
            public override void EncodeFields(GovernancePolicyContentDisposedDetails value, enc.IJsonWriter writer)
            {
                ...
                WriteProperty("disposition_type", value.DispositionType, writer, global::Dropbox.Api.TeamLog.DispositionActionType.Encoder);
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="GovernancePolicyContentDisposedDetails" />.</para>
        /// </summary>
        private class GovernancePolicyContentDisposedDetailsDecoder : enc.StructDecoder<GovernancePolicyContentDisposedDetails>
        {
            ...
            protected override void SetField(GovernancePolicyContentDisposedDetails value, string fieldName, enc.IJsonReader reader)
            {
                switch (fieldName)
                {
                    ...
                    case "disposition_type":
                        value.DispositionType = global::Dropbox.Api.TeamLog.DispositionActionType.Decoder.Decode(reader);
                        break;
                    case "policy_type":

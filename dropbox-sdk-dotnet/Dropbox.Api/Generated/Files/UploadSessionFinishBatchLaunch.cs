...
namespace Dropbox.Api.Files
{
    ...
    /// cref="Dropbox.Api.Files.Routes.FilesUserRoutes.UploadSessionFinishBatchAsync" /> that
    /// may either launch an asynchronous job or complete synchronously.</para>
    /// </summary>
    public class UploadSessionFinishBatchLaunch
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<UploadSessionFinishBatchLaunch> Encoder = new UploadSessionFinishBatchLaunchEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<UploadSessionFinishBatchLaunch> Decoder = new UploadSessionFinishBatchLaunchDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="UploadSessionFinishBatchLaunch"
        /// /> class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="UploadSessionFinishBatchLaunch" />.</para>
        /// </summary>
        private class UploadSessionFinishBatchLaunchEncoder : enc.StructEncoder<UploadSessionFinishBatchLaunch>
        {
            /// <summary>
            ...
            public override void EncodeFields(UploadSessionFinishBatchLaunch value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="UploadSessionFinishBatchLaunch" />.</para>
        /// </summary>
        private class UploadSessionFinishBatchLaunchDecoder : enc.UnionDecoder<UploadSessionFinishBatchLaunch>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="UploadSessionFinishBatchLaunch"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override UploadSessionFinishBatchLaunch Create()
            {
                return new UploadSessionFinishBatchLaunch();
            }
            ...
            protected override UploadSessionFinishBatchLaunch Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "complete":
        ...
        /// </summary>
        public sealed class Complete : UploadSessionFinishBatchLaunch
        {
            #pragma warning disable 108
            ...
            private class CompleteEncoder : enc.StructEncoder<Complete>
            {
                ...
                {
                    WriteProperty("complete", value.Value, writer, global::Dropbox.Api.Files.UploadSessionFinishBatchResult.Encoder);
                }
            }
        ...
        /// </summary>
        public sealed class Other : UploadSessionFinishBatchLaunch
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class AsyncJobId : UploadSessionFinishBatchLaunch
        {
            #pragma warning disable 108

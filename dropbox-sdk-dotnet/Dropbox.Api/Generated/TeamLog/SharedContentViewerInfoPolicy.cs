...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Shared content viewer info policy</para>
    /// </summary>
    public class SharedContentViewerInfoPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<SharedContentViewerInfoPolicy> Encoder = new SharedContentViewerInfoPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<SharedContentViewerInfoPolicy> Decoder = new SharedContentViewerInfoPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="SharedContentViewerInfoPolicy"
        /// /> class.</para>
        /// </summary>
        public SharedContentViewerInfoPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="SharedContentViewerInfoPolicy" />.</para>
        /// </summary>
        private class SharedContentViewerInfoPolicyEncoder : enc.StructEncoder<SharedContentViewerInfoPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(SharedContentViewerInfoPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="SharedContentViewerInfoPolicy" />.</para>
        /// </summary>
        private class SharedContentViewerInfoPolicyDecoder : enc.UnionDecoder<SharedContentViewerInfoPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="SharedContentViewerInfoPolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override SharedContentViewerInfoPolicy Create()
            {
                return new SharedContentViewerInfoPolicy();
            }
            ...
            protected override SharedContentViewerInfoPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : SharedContentViewerInfoPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : SharedContentViewerInfoPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : SharedContentViewerInfoPolicy
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.FileProperties
{
    ...
    /// <summary>
    /// <para>Defines how a single property field may be structured. Used exclusively by <see
    /// cref="PropertyGroupTemplate" />.</para>
    /// </summary>
    public class PropertyFieldTemplate
    {
        ...
        /// class.</para>
        /// </summary>
        /// <param name="name">Key of the property field being described. Property field keys
        ...
        /// <summary>
        /// <para>Key of the property field being described. Property field keys can be up to
        /// 256 bytes.</para>
        /// </summary>
        public string Name { get; protected set; }

        /// <summary>
        /// <para>Description of the property field. Property field descriptions can be up to
        /// 1024 bytes.</para>
        /// </summary>
        ...
        private class PropertyFieldTemplateEncoder : enc.StructEncoder<PropertyFieldTemplate>
        {
            ...
            public override void EncodeFields(PropertyFieldTemplate value, enc.IJsonWriter writer)
            {
                ...
                WriteProperty("type", value.Type, writer, global::Dropbox.Api.FileProperties.PropertyType.Encoder);
            }
        }
            ...
            protected override void SetField(PropertyFieldTemplate value, string fieldName, enc.IJsonReader reader)
            {
                switch (fieldName)
                {
                    ...
                    case "description":
                        ...
                        break;
                    case "type":
                        value.Type = global::Dropbox.Api.FileProperties.PropertyType.Decoder.Decode(reader);
                        break;
                    default:
                        reader.Skip();
                        break;

...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Enable or disable file comments notifications</para>
    /// </summary>
    public class FileCommentNotificationPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<FileCommentNotificationPolicy> Encoder = new FileCommentNotificationPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<FileCommentNotificationPolicy> Decoder = new FileCommentNotificationPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="FileCommentNotificationPolicy"
        /// /> class.</para>
        /// </summary>
        public FileCommentNotificationPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="FileCommentNotificationPolicy" />.</para>
        /// </summary>
        private class FileCommentNotificationPolicyEncoder : enc.StructEncoder<FileCommentNotificationPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(FileCommentNotificationPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="FileCommentNotificationPolicy" />.</para>
        /// </summary>
        private class FileCommentNotificationPolicyDecoder : enc.UnionDecoder<FileCommentNotificationPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="FileCommentNotificationPolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override FileCommentNotificationPolicy Create()
            {
                return new FileCommentNotificationPolicy();
            }
            ...
            protected override FileCommentNotificationPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : FileCommentNotificationPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : FileCommentNotificationPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : FileCommentNotificationPolicy
        {
            #pragma warning disable 108

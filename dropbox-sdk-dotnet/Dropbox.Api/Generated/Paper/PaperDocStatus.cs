...
namespace Dropbox.Api.Paper
{
    ...
    /// <summary>
    /// <para>The status of a Paper doc.</para>
    /// </summary>
    public class PaperDocStatus
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<PaperDocStatus> Encoder = new PaperDocStatusEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<PaperDocStatus> Decoder = new PaperDocStatusDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="PaperDocStatus" /> class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="PaperDocStatus" />.</para>
        /// </summary>
        private class PaperDocStatusEncoder : enc.StructEncoder<PaperDocStatus>
        {
            /// <summary>
            ...
            public override void EncodeFields(PaperDocStatus value, enc.IJsonWriter writer)
            {
                if (value is Active)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="PaperDocStatus" />.</para>
        /// </summary>
        private class PaperDocStatusDecoder : enc.UnionDecoder<PaperDocStatus>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="PaperDocStatus" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override PaperDocStatus Create()
            {
                return new PaperDocStatus();
            }
            ...
            protected override PaperDocStatus Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "active":
        ...
        /// <summary>
        /// <para>The Paper doc is active.</para>
        /// </summary>
        public sealed class Active : PaperDocStatus
        {
            #pragma warning disable 108
        ...
        /// <summary>
        /// <para>The Paper doc is deleted.</para>
        /// </summary>
        public sealed class Deleted : PaperDocStatus
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : PaperDocStatus
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.Files
{
    ...
    /// cref="Dropbox.Api.Files.Routes.FilesUserRoutes.CreateFolderBatchAsync" /> that may
    /// either launch an asynchronous job or complete synchronously.</para>
    /// </summary>
    public class CreateFolderBatchLaunch
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<CreateFolderBatchLaunch> Encoder = new CreateFolderBatchLaunchEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<CreateFolderBatchLaunch> Decoder = new CreateFolderBatchLaunchDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="CreateFolderBatchLaunch" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="CreateFolderBatchLaunch" />.</para>
        /// </summary>
        private class CreateFolderBatchLaunchEncoder : enc.StructEncoder<CreateFolderBatchLaunch>
        {
            /// <summary>
            ...
            public override void EncodeFields(CreateFolderBatchLaunch value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="CreateFolderBatchLaunch" />.</para>
        /// </summary>
        private class CreateFolderBatchLaunchDecoder : enc.UnionDecoder<CreateFolderBatchLaunch>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="CreateFolderBatchLaunch"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override CreateFolderBatchLaunch Create()
            {
                return new CreateFolderBatchLaunch();
            }
            ...
            protected override CreateFolderBatchLaunch Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "complete":
        ...
        /// </summary>
        public sealed class Complete : CreateFolderBatchLaunch
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : CreateFolderBatchLaunch
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class AsyncJobId : CreateFolderBatchLaunch
        {
            #pragma warning disable 108

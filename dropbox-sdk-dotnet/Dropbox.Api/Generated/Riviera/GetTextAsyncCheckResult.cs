...
namespace Dropbox.Api.Riviera
{
    ...
    /// </summary>
    public class GetTextAsyncCheckResult
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<GetTextAsyncCheckResult> Encoder = new GetTextAsyncCheckResultEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<GetTextAsyncCheckResult> Decoder = new GetTextAsyncCheckResultDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="GetTextAsyncCheckResult" />
        /// class.</para>
        /// </summary>
        public GetTextAsyncCheckResult()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="GetTextAsyncCheckResult" />.</para>
        /// </summary>
        private class GetTextAsyncCheckResultEncoder : enc.StructEncoder<GetTextAsyncCheckResult>
        {
            /// <summary>
            ...
            public override void EncodeFields(GetTextAsyncCheckResult value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="GetTextAsyncCheckResult" />.</para>
        /// </summary>
        private class GetTextAsyncCheckResultDecoder : enc.UnionDecoder<GetTextAsyncCheckResult>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="GetTextAsyncCheckResult"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override GetTextAsyncCheckResult Create()
            {
                return new GetTextAsyncCheckResult();
            }
            ...
            protected override GetTextAsyncCheckResult Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "in_progress":
        ...
        /// </summary>
        public sealed class InProgress : GetTextAsyncCheckResult
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Complete : GetTextAsyncCheckResult
        {
            #pragma warning disable 108
            ...
            /// </summary>
            public GetTextResult Value { get; private set; }
            ...
            private class CompleteEncoder : enc.StructEncoder<Complete>
            {
                ...
                {
                    WriteProperty("complete", value.Value, writer, global::Dropbox.Api.Riviera.GetTextResult.Encoder);
                }
            }
            ...
            private class CompleteDecoder : enc.StructDecoder<Complete>
            {
                ...
                {
                    return new Complete(global::Dropbox.Api.Riviera.GetTextResult.Decoder.DecodeFields(reader));
                }
            }
        ...
        /// </summary>
        public sealed class Failed : GetTextAsyncCheckResult
        {
            #pragma warning disable 108
            ...
            /// <para>Gets the value of this instance.</para>
            /// </summary>
            public TextExtractionApiV2Error Value { get; private set; }
            ...
            private class FailedEncoder : enc.StructEncoder<Failed>
            {
                ...
                {
                    WriteProperty("failed", value.Value, writer, global::Dropbox.Api.Riviera.TextExtractionApiV2Error.Encoder);
                }
            }
            ...
            private class FailedDecoder : enc.StructDecoder<Failed>
            {
                ...
                protected override void SetField(Failed value, string fieldName, enc.IJsonReader reader)
                {
                    ...
                    {
                        case "failed":
                            value.Value = global::Dropbox.Api.Riviera.TextExtractionApiV2Error.Decoder.Decode(reader);
                            break;
                        default:
                            reader.Skip();
                            break;
        ...
        /// </summary>
        public sealed class Other : GetTextAsyncCheckResult
        {
            #pragma warning disable 108

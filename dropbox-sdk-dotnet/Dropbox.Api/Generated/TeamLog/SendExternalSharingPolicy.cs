...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for deciding whether team users can share Send content externally</para>
    /// </summary>
    public class SendExternalSharingPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<SendExternalSharingPolicy> Encoder = new SendExternalSharingPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<SendExternalSharingPolicy> Decoder = new SendExternalSharingPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="SendExternalSharingPolicy" />
        /// class.</para>
        /// </summary>
        public SendExternalSharingPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="SendExternalSharingPolicy" />.</para>
        /// </summary>
        private class SendExternalSharingPolicyEncoder : enc.StructEncoder<SendExternalSharingPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(SendExternalSharingPolicy value, enc.IJsonWriter writer)
            {
                if (value is Default)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="SendExternalSharingPolicy" />.</para>
        /// </summary>
        private class SendExternalSharingPolicyDecoder : enc.UnionDecoder<SendExternalSharingPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="SendExternalSharingPolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override SendExternalSharingPolicy Create()
            {
                return new SendExternalSharingPolicy();
            }
            ...
            protected override SendExternalSharingPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "default":
        ...
        /// </summary>
        public sealed class Default : SendExternalSharingPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Disabled : SendExternalSharingPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : SendExternalSharingPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : SendExternalSharingPolicy
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.Sharing
{
    ...
    public class ListFileMembersError
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<ListFileMembersError> Encoder = new ListFileMembersErrorEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<ListFileMembersError> Decoder = new ListFileMembersErrorDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="ListFileMembersError" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="ListFileMembersError" />.</para>
        /// </summary>
        private class ListFileMembersErrorEncoder : enc.StructEncoder<ListFileMembersError>
        {
            /// <summary>
            ...
            public override void EncodeFields(ListFileMembersError value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="ListFileMembersError" />.</para>
        /// </summary>
        private class ListFileMembersErrorDecoder : enc.UnionDecoder<ListFileMembersError>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="ListFileMembersError" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override ListFileMembersError Create()
            {
                return new ListFileMembersError();
            }
            ...
            protected override ListFileMembersError Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "user_error":
        ...
        /// </summary>
        public sealed class UserError : ListFileMembersError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class AccessError : ListFileMembersError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : ListFileMembersError
        {
            #pragma warning disable 108

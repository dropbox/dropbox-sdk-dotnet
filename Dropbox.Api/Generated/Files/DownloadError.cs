...
namespace Dropbox.Api.Files
{
    ...
    public class DownloadError
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<DownloadError> Encoder = new DownloadErrorEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<DownloadError> Decoder = new DownloadErrorDecoder();
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="DownloadError" />.</para>
        /// </summary>
        private class DownloadErrorEncoder : enc.StructEncoder<DownloadError>
        {
            /// <summary>
            ...
            public override void EncodeFields(DownloadError value, enc.IJsonWriter writer)
            {
                if (value is Path)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="DownloadError" />.</para>
        /// </summary>
        private class DownloadErrorDecoder : enc.UnionDecoder<DownloadError>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="DownloadError" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override DownloadError Create()
            {
            ...
            protected override DownloadError Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "path":
        ...
        /// </summary>
        public sealed class Path : DownloadError
        {
            #pragma warning disable 108

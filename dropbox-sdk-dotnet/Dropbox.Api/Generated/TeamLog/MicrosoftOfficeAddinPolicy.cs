...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Microsoft Office addin policy</para>
    /// </summary>
    public class MicrosoftOfficeAddinPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<MicrosoftOfficeAddinPolicy> Encoder = new MicrosoftOfficeAddinPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<MicrosoftOfficeAddinPolicy> Decoder = new MicrosoftOfficeAddinPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="MicrosoftOfficeAddinPolicy" />
        /// class.</para>
        /// </summary>
        public MicrosoftOfficeAddinPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="MicrosoftOfficeAddinPolicy" />.</para>
        /// </summary>
        private class MicrosoftOfficeAddinPolicyEncoder : enc.StructEncoder<MicrosoftOfficeAddinPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(MicrosoftOfficeAddinPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="MicrosoftOfficeAddinPolicy" />.</para>
        /// </summary>
        private class MicrosoftOfficeAddinPolicyDecoder : enc.UnionDecoder<MicrosoftOfficeAddinPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="MicrosoftOfficeAddinPolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override MicrosoftOfficeAddinPolicy Create()
            {
                return new MicrosoftOfficeAddinPolicy();
            }
            ...
            protected override MicrosoftOfficeAddinPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : MicrosoftOfficeAddinPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : MicrosoftOfficeAddinPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : MicrosoftOfficeAddinPolicy
        {
            #pragma warning disable 108

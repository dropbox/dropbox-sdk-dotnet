...
namespace Dropbox.Api.TeamLog
{
    ...
    public class TeamMergeRequestReminderExtraDetails
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<TeamMergeRequestReminderExtraDetails> Encoder = new TeamMergeRequestReminderExtraDetailsEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<TeamMergeRequestReminderExtraDetails> Decoder = new TeamMergeRequestReminderExtraDetailsDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see
        /// cref="TeamMergeRequestReminderExtraDetails" /> class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="TeamMergeRequestReminderExtraDetails" />.</para>
        /// </summary>
        private class TeamMergeRequestReminderExtraDetailsEncoder : enc.StructEncoder<TeamMergeRequestReminderExtraDetails>
        {
            /// <summary>
            ...
            public override void EncodeFields(TeamMergeRequestReminderExtraDetails value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="TeamMergeRequestReminderExtraDetails" />.</para>
        /// </summary>
        private class TeamMergeRequestReminderExtraDetailsDecoder : enc.UnionDecoder<TeamMergeRequestReminderExtraDetails>
        {
            /// <summary>
            /// <para>Create a new instance of type <see
            /// cref="TeamMergeRequestReminderExtraDetails" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override TeamMergeRequestReminderExtraDetails Create()
            {
                return new TeamMergeRequestReminderExtraDetails();
            }
            ...
            protected override TeamMergeRequestReminderExtraDetails Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "primary_team":
        ...
        /// </summary>
        public sealed class PrimaryTeam : TeamMergeRequestReminderExtraDetails
        {
            #pragma warning disable 108
            ...
            /// </summary>
            /// <param name="value">The value</param>
            public PrimaryTeam(PrimaryTeamRequestReminderDetails value)
            {
                this.Value = value;
            }
            /// <summary>
            ...
            /// </summary>
            public PrimaryTeamRequestReminderDetails Value { get; private set; }
            ...
            private class PrimaryTeamEncoder : enc.StructEncoder<PrimaryTeam>
            {
                ...
                {
                    WriteProperty("primary_team", value.Value, writer, global::Dropbox.Api.TeamLog.PrimaryTeamRequestReminderDetails.Encoder);
                }
            }
            ...
            private class PrimaryTeamDecoder : enc.StructDecoder<PrimaryTeam>
            {
                ...
                {
                    return new PrimaryTeam(global::Dropbox.Api.TeamLog.PrimaryTeamRequestReminderDetails.Decoder.DecodeFields(reader));
                }
            }
        ...
        /// </summary>
        public sealed class SecondaryTeam : TeamMergeRequestReminderExtraDetails
        {
            #pragma warning disable 108
            ...
            /// </summary>
            /// <param name="value">The value</param>
            public SecondaryTeam(SecondaryTeamRequestReminderDetails value)
            {
                this.Value = value;
            }
            /// <summary>
            ...
            /// <para>Gets the value of this instance.</para>
            /// </summary>
            public SecondaryTeamRequestReminderDetails Value { get; private set; }
            ...
            private class SecondaryTeamEncoder : enc.StructEncoder<SecondaryTeam>
            {
                ...
                {
                    WriteProperty("secondary_team", value.Value, writer, global::Dropbox.Api.TeamLog.SecondaryTeamRequestReminderDetails.Encoder);
                }
            }
            ...
            private class SecondaryTeamDecoder : enc.StructDecoder<SecondaryTeam>
            {
                ...
                {
                    return new SecondaryTeam(global::Dropbox.Api.TeamLog.SecondaryTeamRequestReminderDetails.Decoder.DecodeFields(reader));
                }
            }
        ...
        /// </summary>
        public sealed class Other : TeamMergeRequestReminderExtraDetails
        {
            #pragma warning disable 108

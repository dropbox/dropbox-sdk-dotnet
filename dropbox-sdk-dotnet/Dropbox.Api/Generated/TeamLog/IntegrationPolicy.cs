...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for controlling whether a service integration is enabled for the
    /// team.</para>
    /// </summary>
    public class IntegrationPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<IntegrationPolicy> Encoder = new IntegrationPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<IntegrationPolicy> Decoder = new IntegrationPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="IntegrationPolicy" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="IntegrationPolicy" />.</para>
        /// </summary>
        private class IntegrationPolicyEncoder : enc.StructEncoder<IntegrationPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(IntegrationPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="IntegrationPolicy" />.</para>
        /// </summary>
        private class IntegrationPolicyDecoder : enc.UnionDecoder<IntegrationPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="IntegrationPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override IntegrationPolicy Create()
            {
                return new IntegrationPolicy();
            }
            ...
            protected override IntegrationPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : IntegrationPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : IntegrationPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : IntegrationPolicy
        {
            #pragma warning disable 108

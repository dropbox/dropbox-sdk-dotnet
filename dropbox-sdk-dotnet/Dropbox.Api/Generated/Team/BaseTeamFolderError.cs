...
namespace Dropbox.Api.Team
{
    ...
    /// <summary>
    /// <para>Base error that all errors for existing team folders should extend.</para>
    /// </summary>
    public class BaseTeamFolderError
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<BaseTeamFolderError> Encoder = new BaseTeamFolderErrorEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<BaseTeamFolderError> Decoder = new BaseTeamFolderErrorDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="BaseTeamFolderError" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="BaseTeamFolderError" />.</para>
        /// </summary>
        private class BaseTeamFolderErrorEncoder : enc.StructEncoder<BaseTeamFolderError>
        {
            /// <summary>
            ...
            public override void EncodeFields(BaseTeamFolderError value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="BaseTeamFolderError" />.</para>
        /// </summary>
        private class BaseTeamFolderErrorDecoder : enc.UnionDecoder<BaseTeamFolderError>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="BaseTeamFolderError" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override BaseTeamFolderError Create()
            {
                return new BaseTeamFolderError();
            }
            ...
            protected override BaseTeamFolderError Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "access_error":
        ...
        /// </summary>
        public sealed class AccessError : BaseTeamFolderError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class StatusError : BaseTeamFolderError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class TeamSharedDropboxError : BaseTeamFolderError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : BaseTeamFolderError
        {
            #pragma warning disable 108

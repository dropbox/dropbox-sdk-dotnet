...
namespace Dropbox.Api.Sharing
{
    ...
    public class RemoveMemberJobStatus
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<RemoveMemberJobStatus> Encoder = new RemoveMemberJobStatusEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<RemoveMemberJobStatus> Decoder = new RemoveMemberJobStatusDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="RemoveMemberJobStatus" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="RemoveMemberJobStatus" />.</para>
        /// </summary>
        private class RemoveMemberJobStatusEncoder : enc.StructEncoder<RemoveMemberJobStatus>
        {
            /// <summary>
            ...
            public override void EncodeFields(RemoveMemberJobStatus value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="RemoveMemberJobStatus" />.</para>
        /// </summary>
        private class RemoveMemberJobStatusDecoder : enc.UnionDecoder<RemoveMemberJobStatus>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="RemoveMemberJobStatus"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override RemoveMemberJobStatus Create()
            {
                return new RemoveMemberJobStatus();
            }
            ...
            protected override RemoveMemberJobStatus Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "complete":
        ...
        /// </summary>
        public sealed class Complete : RemoveMemberJobStatus
        {
            #pragma warning disable 108
            ...
            private class CompleteEncoder : enc.StructEncoder<Complete>
            {
                ...
                {
                    WriteProperty("complete", value.Value, writer, global::Dropbox.Api.Sharing.MemberAccessLevelResult.Encoder);
                }
            }
            ...
            private class CompleteDecoder : enc.StructDecoder<Complete>
            {
                ...
                {
                    return new Complete(global::Dropbox.Api.Sharing.MemberAccessLevelResult.Decoder.DecodeFields(reader));
                }
            }
        ...
        /// </summary>
        public sealed class Failed : RemoveMemberJobStatus
        {
            #pragma warning disable 108
            ...
            /// <para>Gets the value of this instance.</para>
            /// </summary>
            public RemoveFolderMemberError Value { get; private set; }
            ...
            private class FailedEncoder : enc.StructEncoder<Failed>
            {
                ...
                {
                    WriteProperty("failed", value.Value, writer, global::Dropbox.Api.Sharing.RemoveFolderMemberError.Encoder);
                }
            }
        ...
        /// </summary>
        public sealed class InProgress : RemoveMemberJobStatus
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for deciding whether team admins receive email when an invitation to join
    /// the team is accepted</para>
    /// </summary>
    public class InviteAcceptanceEmailPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<InviteAcceptanceEmailPolicy> Encoder = new InviteAcceptanceEmailPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<InviteAcceptanceEmailPolicy> Decoder = new InviteAcceptanceEmailPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="InviteAcceptanceEmailPolicy" />
        /// class.</para>
        /// </summary>
        public InviteAcceptanceEmailPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="InviteAcceptanceEmailPolicy" />.</para>
        /// </summary>
        private class InviteAcceptanceEmailPolicyEncoder : enc.StructEncoder<InviteAcceptanceEmailPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(InviteAcceptanceEmailPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="InviteAcceptanceEmailPolicy" />.</para>
        /// </summary>
        private class InviteAcceptanceEmailPolicyDecoder : enc.UnionDecoder<InviteAcceptanceEmailPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="InviteAcceptanceEmailPolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override InviteAcceptanceEmailPolicy Create()
            {
                return new InviteAcceptanceEmailPolicy();
            }
            ...
            protected override InviteAcceptanceEmailPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : InviteAcceptanceEmailPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : InviteAcceptanceEmailPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : InviteAcceptanceEmailPolicy
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.Team
{
    ...
    /// </summary>
    public class MembersListContinueError
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<MembersListContinueError> Encoder = new MembersListContinueErrorEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<MembersListContinueError> Decoder = new MembersListContinueErrorDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="MembersListContinueError" />
        /// class.</para>
        /// </summary>
        public MembersListContinueError()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="MembersListContinueError" />.</para>
        /// </summary>
        private class MembersListContinueErrorEncoder : enc.StructEncoder<MembersListContinueError>
        {
            /// <summary>
            ...
            public override void EncodeFields(MembersListContinueError value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="MembersListContinueError" />.</para>
        /// </summary>
        private class MembersListContinueErrorDecoder : enc.UnionDecoder<MembersListContinueError>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="MembersListContinueError"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override MembersListContinueError Create()
            {
                return new MembersListContinueError();
            }
            ...
            protected override MembersListContinueError Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "invalid_cursor":
        ...
        /// </summary>
        public sealed class InvalidCursor : MembersListContinueError
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.TeamLog
{
    ...
    public class NetworkControlPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<NetworkControlPolicy> Encoder = new NetworkControlPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<NetworkControlPolicy> Decoder = new NetworkControlPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="NetworkControlPolicy" />
        /// class.</para>
        /// </summary>
        public NetworkControlPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="NetworkControlPolicy" />.</para>
        /// </summary>
        private class NetworkControlPolicyEncoder : enc.StructEncoder<NetworkControlPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(NetworkControlPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="NetworkControlPolicy" />.</para>
        /// </summary>
        private class NetworkControlPolicyDecoder : enc.UnionDecoder<NetworkControlPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="NetworkControlPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override NetworkControlPolicy Create()
            {
                return new NetworkControlPolicy();
            }
            ...
            protected override NetworkControlPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : NetworkControlPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : NetworkControlPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : NetworkControlPolicy
        {
            #pragma warning disable 108

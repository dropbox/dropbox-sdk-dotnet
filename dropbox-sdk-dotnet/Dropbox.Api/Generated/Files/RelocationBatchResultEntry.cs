...
namespace Dropbox.Api.Files
{
    ...
    /// <summary>
    /// <para>The relocation batch result entry object</para>
    /// </summary>
    public class RelocationBatchResultEntry
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<RelocationBatchResultEntry> Encoder = new RelocationBatchResultEntryEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<RelocationBatchResultEntry> Decoder = new RelocationBatchResultEntryDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="RelocationBatchResultEntry" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="RelocationBatchResultEntry" />.</para>
        /// </summary>
        private class RelocationBatchResultEntryEncoder : enc.StructEncoder<RelocationBatchResultEntry>
        {
            /// <summary>
            ...
            public override void EncodeFields(RelocationBatchResultEntry value, enc.IJsonWriter writer)
            {
                if (value is Success)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="RelocationBatchResultEntry" />.</para>
        /// </summary>
        private class RelocationBatchResultEntryDecoder : enc.UnionDecoder<RelocationBatchResultEntry>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="RelocationBatchResultEntry"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override RelocationBatchResultEntry Create()
            {
                return new RelocationBatchResultEntry();
            }
            ...
            protected override RelocationBatchResultEntry Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "success":
        ...
        /// </summary>
        public sealed class Success : RelocationBatchResultEntry
        {
            #pragma warning disable 108
            ...
            private class SuccessEncoder : enc.StructEncoder<Success>
            {
                ...
                {
                    WriteProperty("success", value.Value, writer, global::Dropbox.Api.Files.Metadata.Encoder);
                }
            }
        ...
        /// </summary>
        public sealed class Failure : RelocationBatchResultEntry
        {
            #pragma warning disable 108
            ...
            /// </summary>
            /// <param name="value">The value</param>
            public Failure(RelocationBatchErrorEntry value)
            {
                this.Value = value;
            }
            /// <summary>
            ...
            /// <para>Gets the value of this instance.</para>
            /// </summary>
            public RelocationBatchErrorEntry Value { get; private set; }
            ...
            private class FailureEncoder : enc.StructEncoder<Failure>
            {
                ...
                {
                    WriteProperty("failure", value.Value, writer, global::Dropbox.Api.Files.RelocationBatchErrorEntry.Encoder);
                }
            }
            ...
            private class FailureDecoder : enc.StructDecoder<Failure>
            {
                ...
                protected override void SetField(Failure value, string fieldName, enc.IJsonReader reader)
                {
                    ...
                    {
                        case "failure":
                            value.Value = global::Dropbox.Api.Files.RelocationBatchErrorEntry.Decoder.Decode(reader);
                            break;
                        default:
                            reader.Skip();
                            break;
        ...
        /// </summary>
        public sealed class Other : RelocationBatchResultEntry
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Member suggestions policy</para>
    /// </summary>
    public class MemberSuggestionsPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<MemberSuggestionsPolicy> Encoder = new MemberSuggestionsPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<MemberSuggestionsPolicy> Decoder = new MemberSuggestionsPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="MemberSuggestionsPolicy" />
        /// class.</para>
        /// </summary>
        public MemberSuggestionsPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="MemberSuggestionsPolicy" />.</para>
        /// </summary>
        private class MemberSuggestionsPolicyEncoder : enc.StructEncoder<MemberSuggestionsPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(MemberSuggestionsPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="MemberSuggestionsPolicy" />.</para>
        /// </summary>
        private class MemberSuggestionsPolicyDecoder : enc.UnionDecoder<MemberSuggestionsPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="MemberSuggestionsPolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override MemberSuggestionsPolicy Create()
            {
                return new MemberSuggestionsPolicy();
            }
            ...
            protected override MemberSuggestionsPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : MemberSuggestionsPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : MemberSuggestionsPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : MemberSuggestionsPolicy
        {
            #pragma warning disable 108

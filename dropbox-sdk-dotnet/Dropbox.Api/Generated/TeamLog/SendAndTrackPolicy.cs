...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for deciding whether team users can use Send and Track</para>
    /// </summary>
    public class SendAndTrackPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<SendAndTrackPolicy> Encoder = new SendAndTrackPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<SendAndTrackPolicy> Decoder = new SendAndTrackPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="SendAndTrackPolicy" />
        /// class.</para>
        /// </summary>
        public SendAndTrackPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="SendAndTrackPolicy" />.</para>
        /// </summary>
        private class SendAndTrackPolicyEncoder : enc.StructEncoder<SendAndTrackPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(SendAndTrackPolicy value, enc.IJsonWriter writer)
            {
                if (value is Default)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="SendAndTrackPolicy" />.</para>
        /// </summary>
        private class SendAndTrackPolicyDecoder : enc.UnionDecoder<SendAndTrackPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="SendAndTrackPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override SendAndTrackPolicy Create()
            {
                return new SendAndTrackPolicy();
            }
            ...
            protected override SendAndTrackPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "default":
        ...
        /// </summary>
        public sealed class Default : SendAndTrackPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Disabled : SendAndTrackPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : SendAndTrackPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : SendAndTrackPolicy
        {
            #pragma warning disable 108

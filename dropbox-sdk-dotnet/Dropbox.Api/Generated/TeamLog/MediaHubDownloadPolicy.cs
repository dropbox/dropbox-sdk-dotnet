...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for deciding whether Media Hub content can be downloaded</para>
    /// </summary>
    public class MediaHubDownloadPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<MediaHubDownloadPolicy> Encoder = new MediaHubDownloadPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<MediaHubDownloadPolicy> Decoder = new MediaHubDownloadPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="MediaHubDownloadPolicy" />
        /// class.</para>
        /// </summary>
        public MediaHubDownloadPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="MediaHubDownloadPolicy" />.</para>
        /// </summary>
        private class MediaHubDownloadPolicyEncoder : enc.StructEncoder<MediaHubDownloadPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(MediaHubDownloadPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="MediaHubDownloadPolicy" />.</para>
        /// </summary>
        private class MediaHubDownloadPolicyDecoder : enc.UnionDecoder<MediaHubDownloadPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="MediaHubDownloadPolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override MediaHubDownloadPolicy Create()
            {
                return new MediaHubDownloadPolicy();
            }
            ...
            protected override MediaHubDownloadPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : MediaHubDownloadPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : MediaHubDownloadPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : MediaHubDownloadPolicy
        {
            #pragma warning disable 108

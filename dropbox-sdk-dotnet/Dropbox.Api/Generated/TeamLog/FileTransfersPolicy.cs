...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>File transfers policy</para>
    /// </summary>
    public class FileTransfersPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<FileTransfersPolicy> Encoder = new FileTransfersPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<FileTransfersPolicy> Decoder = new FileTransfersPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="FileTransfersPolicy" />
        /// class.</para>
        /// </summary>
        public FileTransfersPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="FileTransfersPolicy" />.</para>
        /// </summary>
        private class FileTransfersPolicyEncoder : enc.StructEncoder<FileTransfersPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(FileTransfersPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="FileTransfersPolicy" />.</para>
        /// </summary>
        private class FileTransfersPolicyDecoder : enc.UnionDecoder<FileTransfersPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="FileTransfersPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override FileTransfersPolicy Create()
            {
                return new FileTransfersPolicy();
            }
            ...
            protected override FileTransfersPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : FileTransfersPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : FileTransfersPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : FileTransfersPolicy
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>The secondary mails policy object</para>
    /// </summary>
    public class SecondaryMailsPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<SecondaryMailsPolicy> Encoder = new SecondaryMailsPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<SecondaryMailsPolicy> Decoder = new SecondaryMailsPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="SecondaryMailsPolicy" />
        /// class.</para>
        /// </summary>
        public SecondaryMailsPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="SecondaryMailsPolicy" />.</para>
        /// </summary>
        private class SecondaryMailsPolicyEncoder : enc.StructEncoder<SecondaryMailsPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(SecondaryMailsPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="SecondaryMailsPolicy" />.</para>
        /// </summary>
        private class SecondaryMailsPolicyDecoder : enc.UnionDecoder<SecondaryMailsPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="SecondaryMailsPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override SecondaryMailsPolicy Create()
            {
                return new SecondaryMailsPolicy();
            }
            ...
            protected override SecondaryMailsPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : SecondaryMailsPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : SecondaryMailsPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : SecondaryMailsPolicy
        {
            #pragma warning disable 108

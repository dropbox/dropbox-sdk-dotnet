...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for pemanent content deletion</para>
    /// </summary>
    public class ContentPermanentDeletePolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<ContentPermanentDeletePolicy> Encoder = new ContentPermanentDeletePolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<ContentPermanentDeletePolicy> Decoder = new ContentPermanentDeletePolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="ContentPermanentDeletePolicy" />
        /// class.</para>
        /// </summary>
        public ContentPermanentDeletePolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="ContentPermanentDeletePolicy" />.</para>
        /// </summary>
        private class ContentPermanentDeletePolicyEncoder : enc.StructEncoder<ContentPermanentDeletePolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(ContentPermanentDeletePolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="ContentPermanentDeletePolicy" />.</para>
        /// </summary>
        private class ContentPermanentDeletePolicyDecoder : enc.UnionDecoder<ContentPermanentDeletePolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="ContentPermanentDeletePolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override ContentPermanentDeletePolicy Create()
            {
                return new ContentPermanentDeletePolicy();
            }
            ...
            protected override ContentPermanentDeletePolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : ContentPermanentDeletePolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : ContentPermanentDeletePolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : ContentPermanentDeletePolicy
        {
            #pragma warning disable 108

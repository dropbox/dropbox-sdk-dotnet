...
namespace Dropbox.Api.TeamPolicies
{
    ...
    /// <summary>
    /// <para>The password control mode object</para>
    /// </summary>
    public class PasswordControlMode
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<PasswordControlMode> Encoder = new PasswordControlModeEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<PasswordControlMode> Decoder = new PasswordControlModeDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="PasswordControlMode" />
        /// class.</para>
        /// </summary>
        public PasswordControlMode()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="PasswordControlMode" />.</para>
        /// </summary>
        private class PasswordControlModeEncoder : enc.StructEncoder<PasswordControlMode>
        {
            /// <summary>
            ...
            public override void EncodeFields(PasswordControlMode value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="PasswordControlMode" />.</para>
        /// </summary>
        private class PasswordControlModeDecoder : enc.UnionDecoder<PasswordControlMode>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="PasswordControlMode" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override PasswordControlMode Create()
            {
                return new PasswordControlMode();
            }
            ...
            protected override PasswordControlMode Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// <summary>
        /// <para>Password is disabled.</para>
        /// </summary>
        public sealed class Disabled : PasswordControlMode
        {
            #pragma warning disable 108
        ...
        /// <summary>
        /// <para>Password is enabled.</para>
        /// </summary>
        public sealed class Enabled : PasswordControlMode
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : PasswordControlMode
        {
            #pragma warning disable 108

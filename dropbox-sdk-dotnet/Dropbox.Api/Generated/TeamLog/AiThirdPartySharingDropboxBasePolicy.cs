...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for deciding whether team users can use third party AI services</para>
    /// </summary>
    public class AiThirdPartySharingDropboxBasePolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<AiThirdPartySharingDropboxBasePolicy> Encoder = new AiThirdPartySharingDropboxBasePolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<AiThirdPartySharingDropboxBasePolicy> Decoder = new AiThirdPartySharingDropboxBasePolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see
        /// cref="AiThirdPartySharingDropboxBasePolicy" /> class.</para>
        /// </summary>
        public AiThirdPartySharingDropboxBasePolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="AiThirdPartySharingDropboxBasePolicy" />.</para>
        /// </summary>
        private class AiThirdPartySharingDropboxBasePolicyEncoder : enc.StructEncoder<AiThirdPartySharingDropboxBasePolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(AiThirdPartySharingDropboxBasePolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="AiThirdPartySharingDropboxBasePolicy" />.</para>
        /// </summary>
        private class AiThirdPartySharingDropboxBasePolicyDecoder : enc.UnionDecoder<AiThirdPartySharingDropboxBasePolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see
            /// cref="AiThirdPartySharingDropboxBasePolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override AiThirdPartySharingDropboxBasePolicy Create()
            {
                return new AiThirdPartySharingDropboxBasePolicy();
            }
            ...
            protected override AiThirdPartySharingDropboxBasePolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "admins_only":
        ...
        /// </summary>
        public sealed class AdminsOnly : AiThirdPartySharingDropboxBasePolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Default : AiThirdPartySharingDropboxBasePolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Disabled : AiThirdPartySharingDropboxBasePolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : AiThirdPartySharingDropboxBasePolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : AiThirdPartySharingDropboxBasePolicy
        {
            #pragma warning disable 108

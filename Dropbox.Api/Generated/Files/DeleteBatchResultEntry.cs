...
namespace Dropbox.Api.Files
{
    ...
    /// <summary>
    /// <para>The delete batch result entry object</para>
    /// </summary>
    public class DeleteBatchResultEntry
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<DeleteBatchResultEntry> Encoder = new DeleteBatchResultEntryEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<DeleteBatchResultEntry> Decoder = new DeleteBatchResultEntryDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="DeleteBatchResultEntry" />
        /// class.</para>
        /// </summary>
        public DeleteBatchResultEntry()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="DeleteBatchResultEntry" />.</para>
        /// </summary>
        private class DeleteBatchResultEntryEncoder : enc.StructEncoder<DeleteBatchResultEntry>
        {
            /// <summary>
            ...
            public override void EncodeFields(DeleteBatchResultEntry value, enc.IJsonWriter writer)
            {
                if (value is Success)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="DeleteBatchResultEntry" />.</para>
        /// </summary>
        private class DeleteBatchResultEntryDecoder : enc.UnionDecoder<DeleteBatchResultEntry>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="DeleteBatchResultEntry"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override DeleteBatchResultEntry Create()
            {
                return new DeleteBatchResultEntry();
            }
            ...
            protected override DeleteBatchResultEntry Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "success":
        ...
        /// </summary>
        public sealed class Success : DeleteBatchResultEntry
        {
            #pragma warning disable 108
            ...
            private class SuccessEncoder : enc.StructEncoder<Success>
            {
                ...
                {
                    Dropbox.Api.Files.DeleteResult.Encoder.EncodeFields(value.Value, writer);
                }
            }
            ...
            private class SuccessDecoder : enc.StructDecoder<Success>
            {
                ...
                {
                    return new Success(Dropbox.Api.Files.DeleteResult.Decoder.DecodeFields(reader));
                }
            }
        ...
        /// </summary>
        public sealed class Failure : DeleteBatchResultEntry
        {
            #pragma warning disable 108
            ...
            /// </summary>
            /// <param name="value">The value</param>
            public Failure(DeleteError value)
            {
                this.Value = value;
            }
            /// <summary>
            ...
            /// <para>Gets the value of this instance.</para>
            /// </summary>
            public DeleteError Value { get; private set; }
            ...
            private class FailureEncoder : enc.StructEncoder<Failure>
            {
                ...
                {
                    Dropbox.Api.Files.DeleteError.Encoder.EncodeFields(value.Value, writer);
                }
            }
            ...
            private class FailureDecoder : enc.StructDecoder<Failure>
            {
                ...
                protected override void SetField(Failure value, string fieldName, enc.IJsonReader reader)
                {
                    ...
                    {
                        case "failure":
                            value.Value = Dropbox.Api.Files.DeleteError.Decoder.Decode(reader);
                            break;
                        default:
                            reader.Skip();
                            break;

...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for controlling team access to computer backup feature</para>
    /// </summary>
    public class ComputerBackupPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<ComputerBackupPolicy> Encoder = new ComputerBackupPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<ComputerBackupPolicy> Decoder = new ComputerBackupPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="ComputerBackupPolicy" />
        /// class.</para>
        /// </summary>
        public ComputerBackupPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="ComputerBackupPolicy" />.</para>
        /// </summary>
        private class ComputerBackupPolicyEncoder : enc.StructEncoder<ComputerBackupPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(ComputerBackupPolicy value, enc.IJsonWriter writer)
            {
                if (value is Default)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="ComputerBackupPolicy" />.</para>
        /// </summary>
        private class ComputerBackupPolicyDecoder : enc.UnionDecoder<ComputerBackupPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="ComputerBackupPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override ComputerBackupPolicy Create()
            {
                return new ComputerBackupPolicy();
            }
            ...
            protected override ComputerBackupPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "default":
        ...
        /// </summary>
        public sealed class Default : ComputerBackupPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Disabled : ComputerBackupPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : ComputerBackupPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : ComputerBackupPolicy
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.TeamLog
{
    ...
    public class EmailIngestPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<EmailIngestPolicy> Encoder = new EmailIngestPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<EmailIngestPolicy> Decoder = new EmailIngestPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="EmailIngestPolicy" />
        /// class.</para>
        /// </summary>
        public EmailIngestPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="EmailIngestPolicy" />.</para>
        /// </summary>
        private class EmailIngestPolicyEncoder : enc.StructEncoder<EmailIngestPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(EmailIngestPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="EmailIngestPolicy" />.</para>
        /// </summary>
        private class EmailIngestPolicyDecoder : enc.UnionDecoder<EmailIngestPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="EmailIngestPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override EmailIngestPolicy Create()
            {
                return new EmailIngestPolicy();
            }
            ...
            protected override EmailIngestPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : EmailIngestPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : EmailIngestPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : EmailIngestPolicy
        {
            #pragma warning disable 108

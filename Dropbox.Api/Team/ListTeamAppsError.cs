...
namespace Dropbox.Api.Team
{
    ...
    public class ListTeamAppsError
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<ListTeamAppsError> Encoder = new ListTeamAppsErrorEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<ListTeamAppsError> Decoder = new ListTeamAppsErrorDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="ListTeamAppsError" />
        /// class.</para>
        /// </summary>
        public ListTeamAppsError()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="ListTeamAppsError" />.</para>
        /// </summary>
        private class ListTeamAppsErrorEncoder : enc.StructEncoder<ListTeamAppsError>
        {
            /// <summary>
            ...
            public override void EncodeFields(ListTeamAppsError value, enc.IJsonWriter writer)
            {
                if (value is Reset)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="ListTeamAppsError" />.</para>
        /// </summary>
        private class ListTeamAppsErrorDecoder : enc.UnionDecoder<ListTeamAppsError>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="ListTeamAppsError" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override ListTeamAppsError Create()
            {
                return new ListTeamAppsError();
            }
            ...
            protected override ListTeamAppsError Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "reset":
        ...
        /// cref="Dropbox.Api.Team.Routes.TeamRoutes.LinkedAppsListTeamLinkedAppsAsync" />
        /// again with an empty cursor to obtain a new cursor.</para>
        /// </summary>
        public sealed class Reset : ListTeamAppsError
        {
            #pragma warning disable 108

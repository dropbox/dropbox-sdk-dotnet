    ...
    public class UploadSessionFinishBatchResultEntry
    {
        ...
        public sealed class Success : UploadSessionFinishBatchResultEntry
        {
            ...
            private class SuccessDecoder : enc.StructDecoder<Success>
            {
                ...
                {
                    return new Success(global::Dropbox.Api.Files.FileMetadata.Decoder.DecodeFields(reader));
                }
            }
        ...
        public sealed class Failure : UploadSessionFinishBatchResultEntry
        {
            ...
            private class FailureDecoder : enc.StructDecoder<Failure>
            {
                ...
                protected override void SetField(Failure value, string fieldName, enc.IJsonReader reader)
                {
                    ...
                    {
                        case "failure":
                            value.Value = global::Dropbox.Api.Files.UploadSessionFinishError.Decoder.Decode(reader);
                            break;
                        default:
                            reader.Skip();
                            break;

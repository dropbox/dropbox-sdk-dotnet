...
namespace Dropbox.Api.Properties
{
    ...
    public class GetPropertyTemplateResult : PropertyGroupTemplate
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<GetPropertyTemplateResult> Encoder = new GetPropertyTemplateResultEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<GetPropertyTemplateResult> Decoder = new GetPropertyTemplateResultDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="GetPropertyTemplateResult" />
        /// class.</para>
        /// </summary>
        ...
        public GetPropertyTemplateResult(string name,
                                         string description,
        ...
        public GetPropertyTemplateResult()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="GetPropertyTemplateResult" />.</para>
        /// </summary>
        private class GetPropertyTemplateResultEncoder : enc.StructEncoder<GetPropertyTemplateResult>
        {
            /// <summary>
            ...
            public override void EncodeFields(GetPropertyTemplateResult value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="GetPropertyTemplateResult" />.</para>
        /// </summary>
        private class GetPropertyTemplateResultDecoder : enc.StructDecoder<GetPropertyTemplateResult>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="GetPropertyTemplateResult"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override GetPropertyTemplateResult Create()
            {
                return new GetPropertyTemplateResult();
            }

...
namespace Dropbox.Api.FileRequests
{
    ...
    /// <summary>
    /// <para>There is an error with the file request.</para>
    /// </summary>
    public class FileRequestError
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<FileRequestError> Encoder = new FileRequestErrorEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<FileRequestError> Decoder = new FileRequestErrorDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="FileRequestError" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="FileRequestError" />.</para>
        /// </summary>
        private class FileRequestErrorEncoder : enc.StructEncoder<FileRequestError>
        {
            /// <summary>
            ...
            public override void EncodeFields(FileRequestError value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="FileRequestError" />.</para>
        /// </summary>
        private class FileRequestErrorDecoder : enc.UnionDecoder<FileRequestError>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="FileRequestError" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override FileRequestError Create()
            {
                return new FileRequestError();
            }
            ...
            protected override FileRequestError Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "not_found":
        ...
        /// </summary>
        public sealed class NotFound : FileRequestError
        {
            #pragma warning disable 108
        ...
        /// request.</para>
        /// </summary>
        public sealed class NoPermission : FileRequestError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class EmailUnverified : FileRequestError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class ValidationError : FileRequestError
        {
            #pragma warning disable 108
        ...
        /// folder</para>
        /// </summary>
        public sealed class NoWritePermission : FileRequestError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class DisabledForTeam : FileRequestError
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : FileRequestError
        {
            #pragma warning disable 108

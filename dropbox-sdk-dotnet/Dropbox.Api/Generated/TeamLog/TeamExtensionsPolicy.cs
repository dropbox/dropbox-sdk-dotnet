...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for controlling whether App Integrations are enabled for the team.</para>
    /// </summary>
    public class TeamExtensionsPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<TeamExtensionsPolicy> Encoder = new TeamExtensionsPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<TeamExtensionsPolicy> Decoder = new TeamExtensionsPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="TeamExtensionsPolicy" />
        /// class.</para>
        /// </summary>
        public TeamExtensionsPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="TeamExtensionsPolicy" />.</para>
        /// </summary>
        private class TeamExtensionsPolicyEncoder : enc.StructEncoder<TeamExtensionsPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(TeamExtensionsPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="TeamExtensionsPolicy" />.</para>
        /// </summary>
        private class TeamExtensionsPolicyDecoder : enc.UnionDecoder<TeamExtensionsPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="TeamExtensionsPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override TeamExtensionsPolicy Create()
            {
                return new TeamExtensionsPolicy();
            }
            ...
            protected override TeamExtensionsPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : TeamExtensionsPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : TeamExtensionsPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : TeamExtensionsPolicy
        {
            #pragma warning disable 108

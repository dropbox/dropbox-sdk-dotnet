...
namespace Dropbox.Api.Sharing
{
    ...
    /// <summary>
    /// <para>The share path error v2 object</para>
    /// </summary>
    public class SharePathErrorV2
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<SharePathErrorV2> Encoder = new SharePathErrorV2Encoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<SharePathErrorV2> Decoder = new SharePathErrorV2Decoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="SharePathErrorV2" />
        /// class.</para>
        /// </summary>
        ...
        public bool IsIsFamily
        {
            get
            {
                return this is IsFamily;
            }
        }

        /// <summary>
        /// <para>Gets this instance as a IsFamily, or <c>null</c>.</para>
        /// </summary>
        public IsFamily AsIsFamily
        {
            get
            {
                return this as IsFamily;
            }
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="SharePathErrorV2" />.</para>
        /// </summary>
        private class SharePathErrorV2Encoder : enc.StructEncoder<SharePathErrorV2>
        {
            /// <summary>
            ...
            public override void EncodeFields(SharePathErrorV2 value, enc.IJsonWriter writer)
            {
                if (value is IsFamily)
                {
                    WriteProperty(".tag", "is_family", writer, enc.StringEncoder.Instance);
                    IsFamily.Encoder.EncodeFields((IsFamily)value, writer);
                    return;
                }
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="SharePathErrorV2" />.</para>
        /// </summary>
        private class SharePathErrorV2Decoder : enc.UnionDecoder<SharePathErrorV2>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="SharePathErrorV2" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override SharePathErrorV2 Create()
            {
                return new SharePathErrorV2();
            }
            ...
            protected override SharePathErrorV2 Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "is_family":
        ...
        /// </summary>
        public sealed class IsFamily : SharePathErrorV2
        {
            #pragma warning disable 108
            ...
            /// <para>The encoder instance.</para>
            /// </summary>
            internal static enc.StructEncoder<IsFamily> Encoder = new IsFamilyEncoder();

            /// <summary>
            /// <para>The decoder instance.</para>
            /// </summary>
            internal static enc.StructDecoder<IsFamily> Decoder = new IsFamilyDecoder();

            /// <summary>
            /// <para>Initializes a new instance of the <see cref="IsFamily" /> class.</para>
            /// </summary>
            private IsFamily()
            {
            }
            ...
            /// <summary>
            /// <para>A singleton instance of IsFamily</para>
            /// </summary>
            public static readonly IsFamily Instance = new IsFamily();

            #region Encoder class

            /// <summary>
            /// <para>Encoder for  <see cref="IsFamily" />.</para>
            /// </summary>
            private class IsFamilyEncoder : enc.StructEncoder<IsFamily>
            {
                /// <summary>
                /// <para>Encode fields of given value.</para>
                /// </summary>
                /// <param name="value">The value.</param>
                /// <param name="writer">The writer.</param>
                public override void EncodeFields(IsFamily value, enc.IJsonWriter writer)
                {
                }
            }
            ...
            /// <summary>
            /// <para>Decoder for  <see cref="IsFamily" />.</para>
            /// </summary>
            private class IsFamilyDecoder : enc.StructDecoder<IsFamily>
            {
                /// <summary>
                /// <para>Create a new instance of type <see cref="IsFamily" />.</para>
                /// </summary>
                /// <returns>The struct instance.</returns>
                protected override IsFamily Create()
                {
                    return IsFamily.Instance;
                }
        ...
        /// </summary>
        public sealed class ContainsAppFolder : SharePathErrorV2
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class IsFile : SharePathErrorV2
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class InsideSharedFolder : SharePathErrorV2
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class ContainsSharedFolder : SharePathErrorV2
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class ContainsTeamFolder : SharePathErrorV2
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class IsAppFolder : SharePathErrorV2
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class InsideAppFolder : SharePathErrorV2
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class IsPublicFolder : SharePathErrorV2
        {
            #pragma warning disable 108
        ...
        /// instead.</para>
        /// </summary>
        public sealed class InsidePublicFolder : SharePathErrorV2
        {
            #pragma warning disable 108
        ...
        /// folder.</para>
        /// </summary>
        public sealed class AlreadyShared : SharePathErrorV2
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class InvalidPath : SharePathErrorV2
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class IsOsxPackage : SharePathErrorV2
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class InsideOsxPackage : SharePathErrorV2
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : SharePathErrorV2
        {
            #pragma warning disable 108

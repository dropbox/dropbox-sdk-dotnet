...
namespace Dropbox.Api.TeamLog
{
    ...
    /// </summary>
    public class SharedContentDownloadsPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<SharedContentDownloadsPolicy> Encoder = new SharedContentDownloadsPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<SharedContentDownloadsPolicy> Decoder = new SharedContentDownloadsPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="SharedContentDownloadsPolicy" />
        /// class.</para>
        /// </summary>
        public SharedContentDownloadsPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="SharedContentDownloadsPolicy" />.</para>
        /// </summary>
        private class SharedContentDownloadsPolicyEncoder : enc.StructEncoder<SharedContentDownloadsPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(SharedContentDownloadsPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="SharedContentDownloadsPolicy" />.</para>
        /// </summary>
        private class SharedContentDownloadsPolicyDecoder : enc.UnionDecoder<SharedContentDownloadsPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="SharedContentDownloadsPolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override SharedContentDownloadsPolicy Create()
            {
                return new SharedContentDownloadsPolicy();
            }
            ...
            protected override SharedContentDownloadsPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : SharedContentDownloadsPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : SharedContentDownloadsPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : SharedContentDownloadsPolicy
        {
            #pragma warning disable 108

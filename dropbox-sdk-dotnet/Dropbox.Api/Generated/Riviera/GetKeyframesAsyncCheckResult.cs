...
namespace Dropbox.Api.Riviera
{
    ...
    /// </summary>
    public class GetKeyframesAsyncCheckResult
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<GetKeyframesAsyncCheckResult> Encoder = new GetKeyframesAsyncCheckResultEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<GetKeyframesAsyncCheckResult> Decoder = new GetKeyframesAsyncCheckResultDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="GetKeyframesAsyncCheckResult" />
        /// class.</para>
        /// </summary>
        public GetKeyframesAsyncCheckResult()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="GetKeyframesAsyncCheckResult" />.</para>
        /// </summary>
        private class GetKeyframesAsyncCheckResultEncoder : enc.StructEncoder<GetKeyframesAsyncCheckResult>
        {
            /// <summary>
            ...
            public override void EncodeFields(GetKeyframesAsyncCheckResult value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="GetKeyframesAsyncCheckResult" />.</para>
        /// </summary>
        private class GetKeyframesAsyncCheckResultDecoder : enc.UnionDecoder<GetKeyframesAsyncCheckResult>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="GetKeyframesAsyncCheckResult"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override GetKeyframesAsyncCheckResult Create()
            {
                return new GetKeyframesAsyncCheckResult();
            }
            ...
            protected override GetKeyframesAsyncCheckResult Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "in_progress":
        ...
        /// </summary>
        public sealed class InProgress : GetKeyframesAsyncCheckResult
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Complete : GetKeyframesAsyncCheckResult
        {
            #pragma warning disable 108
            ...
            /// </summary>
            public GetKeyframesResult Value { get; private set; }
            ...
            private class CompleteEncoder : enc.StructEncoder<Complete>
            {
                ...
                {
                    WriteProperty("complete", value.Value, writer, global::Dropbox.Api.Riviera.GetKeyframesResult.Encoder);
                }
            }
            ...
            private class CompleteDecoder : enc.StructDecoder<Complete>
            {
                ...
                {
                    return new Complete(global::Dropbox.Api.Riviera.GetKeyframesResult.Decoder.DecodeFields(reader));
                }
            }
        ...
        /// </summary>
        public sealed class Failed : GetKeyframesAsyncCheckResult
        {
            #pragma warning disable 108
            ...
            /// <para>Gets the value of this instance.</para>
            /// </summary>
            public KeyframesExtractionApiV2Error Value { get; private set; }
            ...
            private class FailedEncoder : enc.StructEncoder<Failed>
            {
                ...
                {
                    WriteProperty("failed", value.Value, writer, global::Dropbox.Api.Riviera.KeyframesExtractionApiV2Error.Encoder);
                }
            }
            ...
            private class FailedDecoder : enc.StructDecoder<Failed>
            {
                ...
                protected override void SetField(Failed value, string fieldName, enc.IJsonReader reader)
                {
                    ...
                    {
                        case "failed":
                            value.Value = global::Dropbox.Api.Riviera.KeyframesExtractionApiV2Error.Decoder.Decode(reader);
                            break;
                        default:
                            reader.Skip();
                            break;
        ...
        /// </summary>
        public sealed class Other : GetKeyframesAsyncCheckResult
        {
            #pragma warning disable 108

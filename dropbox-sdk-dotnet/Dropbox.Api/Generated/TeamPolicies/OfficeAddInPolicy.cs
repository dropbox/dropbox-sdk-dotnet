...
namespace Dropbox.Api.TeamPolicies
{
    ...
    /// <summary>
    /// <para>The office add in policy object</para>
    /// </summary>
    public class OfficeAddInPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<OfficeAddInPolicy> Encoder = new OfficeAddInPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<OfficeAddInPolicy> Decoder = new OfficeAddInPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="OfficeAddInPolicy" />
        /// class.</para>
        /// </summary>
        public OfficeAddInPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="OfficeAddInPolicy" />.</para>
        /// </summary>
        private class OfficeAddInPolicyEncoder : enc.StructEncoder<OfficeAddInPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(OfficeAddInPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="OfficeAddInPolicy" />.</para>
        /// </summary>
        private class OfficeAddInPolicyDecoder : enc.UnionDecoder<OfficeAddInPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="OfficeAddInPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override OfficeAddInPolicy Create()
            {
                return new OfficeAddInPolicy();
            }
            ...
            protected override OfficeAddInPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// <summary>
        /// <para>Office Add-In is disabled.</para>
        /// </summary>
        public sealed class Disabled : OfficeAddInPolicy
        {
            #pragma warning disable 108
        ...
        /// <summary>
        /// <para>Office Add-In is enabled.</para>
        /// </summary>
        public sealed class Enabled : OfficeAddInPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : OfficeAddInPolicy
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.TeamLog
{
    ...
    public class ObjectLabelRemovedDetails
    {
        ...
        public ObjectLabelRemovedDetails()
        {
        }
        ...
        private class ObjectLabelRemovedDetailsDecoder : enc.StructDecoder<ObjectLabelRemovedDetails>
        {
            ...
            protected override void SetField(ObjectLabelRemovedDetails value, string fieldName, enc.IJsonReader reader)
            {
                switch (fieldName)
                {
                    case "label_type":

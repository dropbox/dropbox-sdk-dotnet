    ...
    public class RelocationBatchLaunch
    {
        ...
        public sealed class Complete : RelocationBatchLaunch
        {
            ...
            private class CompleteEncoder : enc.StructEncoder<Complete>
            {
                ...
                {
                    Dropbox.Api.Files.RelocationBatchResult.Encoder.EncodeFields(value.Value, writer);
                }
            }
            ...
            private class CompleteDecoder : enc.StructDecoder<Complete>
            {
                ...
                {
                    return new Complete(Dropbox.Api.Files.RelocationBatchResult.Decoder.DecodeFields(reader));
                }
            }

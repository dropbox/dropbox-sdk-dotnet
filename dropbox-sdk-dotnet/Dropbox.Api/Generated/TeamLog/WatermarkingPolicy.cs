...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for controlling team access to watermarking feature</para>
    /// </summary>
    public class WatermarkingPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<WatermarkingPolicy> Encoder = new WatermarkingPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<WatermarkingPolicy> Decoder = new WatermarkingPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="WatermarkingPolicy" />
        /// class.</para>
        /// </summary>
        public WatermarkingPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="WatermarkingPolicy" />.</para>
        /// </summary>
        private class WatermarkingPolicyEncoder : enc.StructEncoder<WatermarkingPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(WatermarkingPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="WatermarkingPolicy" />.</para>
        /// </summary>
        private class WatermarkingPolicyDecoder : enc.UnionDecoder<WatermarkingPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="WatermarkingPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override WatermarkingPolicy Create()
            {
                return new WatermarkingPolicy();
            }
            ...
            protected override WatermarkingPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : WatermarkingPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : WatermarkingPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : WatermarkingPolicy
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.Riviera
{
    ...
    public class GetMarkdownAsyncCheckResult
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<GetMarkdownAsyncCheckResult> Encoder = new GetMarkdownAsyncCheckResultEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<GetMarkdownAsyncCheckResult> Decoder = new GetMarkdownAsyncCheckResultDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="GetMarkdownAsyncCheckResult" />
        /// class.</para>
        /// </summary>
        public GetMarkdownAsyncCheckResult()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="GetMarkdownAsyncCheckResult" />.</para>
        /// </summary>
        private class GetMarkdownAsyncCheckResultEncoder : enc.StructEncoder<GetMarkdownAsyncCheckResult>
        {
            /// <summary>
            ...
            public override void EncodeFields(GetMarkdownAsyncCheckResult value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="GetMarkdownAsyncCheckResult" />.</para>
        /// </summary>
        private class GetMarkdownAsyncCheckResultDecoder : enc.UnionDecoder<GetMarkdownAsyncCheckResult>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="GetMarkdownAsyncCheckResult"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override GetMarkdownAsyncCheckResult Create()
            {
                return new GetMarkdownAsyncCheckResult();
            }
            ...
            protected override GetMarkdownAsyncCheckResult Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "in_progress":
        ...
        public sealed class Complete : GetMarkdownAsyncCheckResult
        {
            ...
            /// </summary>
            public GetMarkdownResult Value { get; private set; }
            ...
            private class CompleteEncoder : enc.StructEncoder<Complete>
            {
                ...
                {
                    WriteProperty("complete", value.Value, writer, global::Dropbox.Api.Riviera.GetMarkdownResult.Encoder);
                }
            }
            ...
            private class CompleteDecoder : enc.StructDecoder<Complete>
            {
                ...
                {
                    return new Complete(global::Dropbox.Api.Riviera.GetMarkdownResult.Decoder.DecodeFields(reader));
                }
            }
        ...
        public sealed class Failed : GetMarkdownAsyncCheckResult
        {
            ...
            /// </summary>
            /// <param name="value">The value</param>
            public Failed(MarkdownConversionApiV2Error value)
            {
                this.Value = value;
            }
            /// <summary>
            ...
            /// <para>Gets the value of this instance.</para>
            /// </summary>
            public MarkdownConversionApiV2Error Value { get; private set; }
            ...
            private class FailedEncoder : enc.StructEncoder<Failed>
            {
                ...
                {
                    WriteProperty("failed", value.Value, writer, global::Dropbox.Api.Riviera.MarkdownConversionApiV2Error.Encoder);
                }
            }
            ...
            private class FailedDecoder : enc.StructDecoder<Failed>
            {
                ...
                protected override void SetField(Failed value, string fieldName, enc.IJsonReader reader)
                {
                    ...
                    {
                        case "failed":
                            value.Value = global::Dropbox.Api.Riviera.MarkdownConversionApiV2Error.Decoder.Decode(reader);
                            break;
                        default:
                            reader.Skip();
                            break;
        ...
        /// </summary>
        public sealed class Other : GetMarkdownAsyncCheckResult
        {
            #pragma warning disable 108

...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for deciding who can be added to Media Hub content</para>
    /// </summary>
    public class MediaHubAddingPeoplePolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<MediaHubAddingPeoplePolicy> Encoder = new MediaHubAddingPeoplePolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<MediaHubAddingPeoplePolicy> Decoder = new MediaHubAddingPeoplePolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="MediaHubAddingPeoplePolicy" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="MediaHubAddingPeoplePolicy" />.</para>
        /// </summary>
        private class MediaHubAddingPeoplePolicyEncoder : enc.StructEncoder<MediaHubAddingPeoplePolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(MediaHubAddingPeoplePolicy value, enc.IJsonWriter writer)
            {
                if (value is Anyone)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="MediaHubAddingPeoplePolicy" />.</para>
        /// </summary>
        private class MediaHubAddingPeoplePolicyDecoder : enc.UnionDecoder<MediaHubAddingPeoplePolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="MediaHubAddingPeoplePolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override MediaHubAddingPeoplePolicy Create()
            {
                return new MediaHubAddingPeoplePolicy();
            }
            ...
            protected override MediaHubAddingPeoplePolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "anyone":
        ...
        /// </summary>
        public sealed class Anyone : MediaHubAddingPeoplePolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class TeamOnly : MediaHubAddingPeoplePolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : MediaHubAddingPeoplePolicy
        {
            #pragma warning disable 108

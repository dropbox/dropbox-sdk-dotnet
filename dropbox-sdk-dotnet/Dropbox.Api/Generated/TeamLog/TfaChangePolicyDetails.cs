...
namespace Dropbox.Api.TeamLog
{
    ...
    public class TfaChangePolicyDetails
    {
        ...
        public TfaChangePolicyDetails(global::Dropbox.Api.TeamPolicies.TwoStepVerificationPolicy newValue,
                                      global::Dropbox.Api.TeamPolicies.TwoStepVerificationPolicy previousValue = null)
        {
            if (newValue == null)
            {
        ...
        /// </summary>
        public global::Dropbox.Api.TeamPolicies.TwoStepVerificationPolicy NewValue { get; protected set; }

        /// <summary>
        /// <para>Previous change policy. Might be missing due to historical data gap.</para>
        /// </summary>
        public global::Dropbox.Api.TeamPolicies.TwoStepVerificationPolicy PreviousValue { get; protected set; }
        ...
        private class TfaChangePolicyDetailsEncoder : enc.StructEncoder<TfaChangePolicyDetails>
        {
            ...
            {
                WriteProperty("new_value", value.NewValue, writer, global::Dropbox.Api.TeamPolicies.TwoStepVerificationPolicy.Encoder);
                if (value.PreviousValue != null)
                {
                    WriteProperty("previous_value", value.PreviousValue, writer, global::Dropbox.Api.TeamPolicies.TwoStepVerificationPolicy.Encoder);
                }
            }
        }
        ...
        private class TfaChangePolicyDetailsDecoder : enc.StructDecoder<TfaChangePolicyDetails>
        {
            ...
            protected override void SetField(TfaChangePolicyDetails value, string fieldName, enc.IJsonReader reader)
            {
                ...
                {
                    case "new_value":
                        value.NewValue = global::Dropbox.Api.TeamPolicies.TwoStepVerificationPolicy.Decoder.Decode(reader);
                        break;
                    case "previous_value":
                        value.PreviousValue = global::Dropbox.Api.TeamPolicies.TwoStepVerificationPolicy.Decoder.Decode(reader);
                        break;
                    default:
                        reader.Skip();
                        break;

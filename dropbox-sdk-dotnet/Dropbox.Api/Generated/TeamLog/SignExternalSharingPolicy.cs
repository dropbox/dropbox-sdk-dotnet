...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Policy for deciding whether team users can share Sign content externally</para>
    /// </summary>
    public class SignExternalSharingPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<SignExternalSharingPolicy> Encoder = new SignExternalSharingPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<SignExternalSharingPolicy> Decoder = new SignExternalSharingPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="SignExternalSharingPolicy" />
        /// class.</para>
        /// </summary>
        public SignExternalSharingPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="SignExternalSharingPolicy" />.</para>
        /// </summary>
        private class SignExternalSharingPolicyEncoder : enc.StructEncoder<SignExternalSharingPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(SignExternalSharingPolicy value, enc.IJsonWriter writer)
            {
                if (value is Default)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="SignExternalSharingPolicy" />.</para>
        /// </summary>
        private class SignExternalSharingPolicyDecoder : enc.UnionDecoder<SignExternalSharingPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="SignExternalSharingPolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override SignExternalSharingPolicy Create()
            {
                return new SignExternalSharingPolicy();
            }
            ...
            protected override SignExternalSharingPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "default":
        ...
        /// </summary>
        public sealed class Default : SignExternalSharingPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Disabled : SignExternalSharingPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : SignExternalSharingPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : SignExternalSharingPolicy
        {
            #pragma warning disable 108

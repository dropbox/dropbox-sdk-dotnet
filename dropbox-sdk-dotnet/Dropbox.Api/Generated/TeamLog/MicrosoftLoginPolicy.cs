...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Microsoft login policy</para>
    /// </summary>
    public class MicrosoftLoginPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<MicrosoftLoginPolicy> Encoder = new MicrosoftLoginPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<MicrosoftLoginPolicy> Decoder = new MicrosoftLoginPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="MicrosoftLoginPolicy" />
        /// class.</para>
        /// </summary>
        public MicrosoftLoginPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="MicrosoftLoginPolicy" />.</para>
        /// </summary>
        private class MicrosoftLoginPolicyEncoder : enc.StructEncoder<MicrosoftLoginPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(MicrosoftLoginPolicy value, enc.IJsonWriter writer)
            {
                if (value is Default)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="MicrosoftLoginPolicy" />.</para>
        /// </summary>
        private class MicrosoftLoginPolicyDecoder : enc.UnionDecoder<MicrosoftLoginPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="MicrosoftLoginPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override MicrosoftLoginPolicy Create()
            {
                return new MicrosoftLoginPolicy();
            }
            ...
            protected override MicrosoftLoginPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "default":
        ...
        /// </summary>
        public sealed class Default : MicrosoftLoginPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Disabled : MicrosoftLoginPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : MicrosoftLoginPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : MicrosoftLoginPolicy
        {
            #pragma warning disable 108

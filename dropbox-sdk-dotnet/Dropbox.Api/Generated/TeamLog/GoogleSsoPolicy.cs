...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Google SSO policy</para>
    /// </summary>
    public class GoogleSsoPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<GoogleSsoPolicy> Encoder = new GoogleSsoPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<GoogleSsoPolicy> Decoder = new GoogleSsoPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="GoogleSsoPolicy" />
        /// class.</para>
        /// </summary>
        public GoogleSsoPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="GoogleSsoPolicy" />.</para>
        /// </summary>
        private class GoogleSsoPolicyEncoder : enc.StructEncoder<GoogleSsoPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(GoogleSsoPolicy value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="GoogleSsoPolicy" />.</para>
        /// </summary>
        private class GoogleSsoPolicyDecoder : enc.UnionDecoder<GoogleSsoPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="GoogleSsoPolicy" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override GoogleSsoPolicy Create()
            {
                return new GoogleSsoPolicy();
            }
            ...
            protected override GoogleSsoPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "disabled":
        ...
        /// </summary>
        public sealed class Disabled : GoogleSsoPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : GoogleSsoPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : GoogleSsoPolicy
        {
            #pragma warning disable 108

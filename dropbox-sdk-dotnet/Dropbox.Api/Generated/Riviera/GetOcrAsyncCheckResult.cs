...
namespace Dropbox.Api.Riviera
{
    ...
    public class GetOcrAsyncCheckResult
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<GetOcrAsyncCheckResult> Encoder = new GetOcrAsyncCheckResultEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<GetOcrAsyncCheckResult> Decoder = new GetOcrAsyncCheckResultDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="GetOcrAsyncCheckResult" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="GetOcrAsyncCheckResult" />.</para>
        /// </summary>
        private class GetOcrAsyncCheckResultEncoder : enc.StructEncoder<GetOcrAsyncCheckResult>
        {
            /// <summary>
            ...
            public override void EncodeFields(GetOcrAsyncCheckResult value, enc.IJsonWriter writer)
            {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="GetOcrAsyncCheckResult" />.</para>
        /// </summary>
        private class GetOcrAsyncCheckResultDecoder : enc.UnionDecoder<GetOcrAsyncCheckResult>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="GetOcrAsyncCheckResult"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override GetOcrAsyncCheckResult Create()
            {
                return new GetOcrAsyncCheckResult();
            }
            ...
            protected override GetOcrAsyncCheckResult Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "in_progress":
        ...
        /// </summary>
        public sealed class InProgress : GetOcrAsyncCheckResult
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Complete : GetOcrAsyncCheckResult
        {
            #pragma warning disable 108
            ...
            /// </summary>
            public GetOcrResult Value { get; private set; }
            ...
            private class CompleteEncoder : enc.StructEncoder<Complete>
            {
                ...
                {
                    WriteProperty("complete", value.Value, writer, global::Dropbox.Api.Riviera.GetOcrResult.Encoder);
                }
            }
            ...
            private class CompleteDecoder : enc.StructDecoder<Complete>
            {
                ...
                {
                    return new Complete(global::Dropbox.Api.Riviera.GetOcrResult.Decoder.DecodeFields(reader));
                }
            }
        ...
        /// </summary>
        public sealed class Failed : GetOcrAsyncCheckResult
        {
            #pragma warning disable 108
            ...
            /// <para>Gets the value of this instance.</para>
            /// </summary>
            public OcrExtractionApiV2Error Value { get; private set; }
            ...
            private class FailedEncoder : enc.StructEncoder<Failed>
            {
                ...
                {
                    WriteProperty("failed", value.Value, writer, global::Dropbox.Api.Riviera.OcrExtractionApiV2Error.Encoder);
                }
            }
            ...
            private class FailedDecoder : enc.StructDecoder<Failed>
            {
                ...
                protected override void SetField(Failed value, string fieldName, enc.IJsonReader reader)
                {
                    ...
                    {
                        case "failed":
                            value.Value = global::Dropbox.Api.Riviera.OcrExtractionApiV2Error.Decoder.Decode(reader);
                            break;
                        default:
                            reader.Skip();
                            break;
        ...
        /// </summary>
        public sealed class Other : GetOcrAsyncCheckResult
        {
            #pragma warning disable 108

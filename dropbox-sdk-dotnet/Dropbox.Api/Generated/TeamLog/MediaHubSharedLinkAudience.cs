...
namespace Dropbox.Api.TeamLog
{
    ...
    public class MediaHubSharedLinkAudience
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<MediaHubSharedLinkAudience> Encoder = new MediaHubSharedLinkAudienceEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<MediaHubSharedLinkAudience> Decoder = new MediaHubSharedLinkAudienceDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="MediaHubSharedLinkAudience" />
        /// class.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="MediaHubSharedLinkAudience" />.</para>
        /// </summary>
        private class MediaHubSharedLinkAudienceEncoder : enc.StructEncoder<MediaHubSharedLinkAudience>
        {
            /// <summary>
            ...
            public override void EncodeFields(MediaHubSharedLinkAudience value, enc.IJsonWriter writer)
            {
                if (value is NoOne)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="MediaHubSharedLinkAudience" />.</para>
        /// </summary>
        private class MediaHubSharedLinkAudienceDecoder : enc.UnionDecoder<MediaHubSharedLinkAudience>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="MediaHubSharedLinkAudience"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override MediaHubSharedLinkAudience Create()
            {
                return new MediaHubSharedLinkAudience();
            }
            ...
            protected override MediaHubSharedLinkAudience Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "no_one":
        ...
        /// </summary>
        public sealed class NoOne : MediaHubSharedLinkAudience
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Public : MediaHubSharedLinkAudience
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class TeamOnly : MediaHubSharedLinkAudience
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : MediaHubSharedLinkAudience
        {
            #pragma warning disable 108

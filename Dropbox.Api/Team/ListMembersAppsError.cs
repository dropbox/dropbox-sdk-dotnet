...
namespace Dropbox.Api.Team
{
    ...
    public class ListMembersAppsError
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<ListMembersAppsError> Encoder = new ListMembersAppsErrorEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<ListMembersAppsError> Decoder = new ListMembersAppsErrorDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="ListMembersAppsError" />
        /// class.</para>
        /// </summary>
        public ListMembersAppsError()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="ListMembersAppsError" />.</para>
        /// </summary>
        private class ListMembersAppsErrorEncoder : enc.StructEncoder<ListMembersAppsError>
        {
            /// <summary>
            ...
            public override void EncodeFields(ListMembersAppsError value, enc.IJsonWriter writer)
            {
                if (value is Reset)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="ListMembersAppsError" />.</para>
        /// </summary>
        private class ListMembersAppsErrorDecoder : enc.UnionDecoder<ListMembersAppsError>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="ListMembersAppsError" />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override ListMembersAppsError Create()
            {
                return new ListMembersAppsError();
            }
            ...
            protected override ListMembersAppsError Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "reset":

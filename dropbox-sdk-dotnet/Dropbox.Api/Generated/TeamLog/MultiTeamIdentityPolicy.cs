...
namespace Dropbox.Api.TeamLog
{
    ...
    /// <summary>
    /// <para>Multi-team identity policy</para>
    /// </summary>
    public class MultiTeamIdentityPolicy
    {
        ...
        /// </summary>
        internal static enc.StructEncoder<MultiTeamIdentityPolicy> Encoder = new MultiTeamIdentityPolicyEncoder();

        /// <summary>
        /// <para>The decoder instance.</para>
        /// </summary>
        internal static enc.StructDecoder<MultiTeamIdentityPolicy> Decoder = new MultiTeamIdentityPolicyDecoder();

        /// <summary>
        /// <para>Initializes a new instance of the <see cref="MultiTeamIdentityPolicy" />
        /// class.</para>
        /// </summary>
        public MultiTeamIdentityPolicy()
        {
        }
        ...
        /// <summary>
        /// <para>Encoder for  <see cref="MultiTeamIdentityPolicy" />.</para>
        /// </summary>
        private class MultiTeamIdentityPolicyEncoder : enc.StructEncoder<MultiTeamIdentityPolicy>
        {
            /// <summary>
            ...
            public override void EncodeFields(MultiTeamIdentityPolicy value, enc.IJsonWriter writer)
            {
                if (value is Default)
                {
        ...
        /// <summary>
        /// <para>Decoder for  <see cref="MultiTeamIdentityPolicy" />.</para>
        /// </summary>
        private class MultiTeamIdentityPolicyDecoder : enc.UnionDecoder<MultiTeamIdentityPolicy>
        {
            /// <summary>
            /// <para>Create a new instance of type <see cref="MultiTeamIdentityPolicy"
            /// />.</para>
            /// </summary>
            /// <returns>The struct instance.</returns>
            protected override MultiTeamIdentityPolicy Create()
            {
                return new MultiTeamIdentityPolicy();
            }
            ...
            protected override MultiTeamIdentityPolicy Decode(string tag, enc.IJsonReader reader)
            {
                switch (tag)
                {
                    case "default":
        ...
        /// </summary>
        public sealed class Default : MultiTeamIdentityPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Disabled : MultiTeamIdentityPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Enabled : MultiTeamIdentityPolicy
        {
            #pragma warning disable 108
        ...
        /// </summary>
        public sealed class Other : MultiTeamIdentityPolicy
        {
            #pragma warning disable 108
